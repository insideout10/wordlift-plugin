...
class SchemaOrg_XRayService {
    ...
    public function scan($className) {
    ...
    private function getDescriptors($docComment) {
        $matches = array();
    ...
    public function getValuesByDescritor(&$xRayClass, $key) {
        
        $descriptors = &$xRayClass[SchemaOrg_XRayService::DESCRIPTORS];
        
        $values = array();

        foreach ($descriptors as $descriptor)
            if ($key === $descriptor[SchemaOrg_XRayService::KEY])
                $values[] = $descriptor[SchemaOrg_XRayService::VALUE];
