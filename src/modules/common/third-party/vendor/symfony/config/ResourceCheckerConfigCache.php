 ...
 */
namespace Wordlift\Modules\Common\Symfony\Component\Config;

use Wordlift\Modules\Common\Symfony\Component\Config\Resource\ResourceInterface;
use Wordlift\Modules\Common\Symfony\Component\Filesystem\Exception\IOException;
use Wordlift\Modules\Common\Symfony\Component\Filesystem\Filesystem;
/**
...
class ResourceCheckerConfigCache implements ConfigCacheInterface {
	...
	private function safelyUnserialize( $file ) {
		...
		$prevErrorHandler       = \set_error_handler(
			function ( $type, $msg, $file, $line, $context = array() ) use ( &$prevErrorHandler, $signalingException ) {
				if ( __FILE__ === $file ) {
