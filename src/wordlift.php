...
add_action( 'admin_init', 'wl_for_jasonbarnard__register_transform_function' );
add_action( 'init', 'wl_for_jasonbarnard__register_transform_function' );

function wl_for_jasonbarnard__register_transform_function() {
	if ( ! interface_exists( 'Wordlift\Mappings\Mappings_Transform_Function' ) ) {
		return;
	}
	 ...
	 */
	$transform_class = new class implements Wordlift\Mappings\Mappings_Transform_Function {

		/**
		 */
		public function __construct() {

			add_filter( 'wl_mappings_transformation_functions', array(
				$this,
