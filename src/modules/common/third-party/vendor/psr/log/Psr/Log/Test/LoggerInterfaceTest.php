...
namespace Wordlift\Modules\Common\Psr\Log\Test;

use Wordlift\Modules\Common\Psr\Log\LoggerInterface;
use Wordlift\Modules\Common\Psr\Log\LogLevel;
use Wordlift\Modules\Common\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('Wordlift\Modules\Common\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('Wordlift\Modules\Common\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('Wordlift\Modules\Common\Psr\Log\Test\DummyTest', array('__toString'));
        }
