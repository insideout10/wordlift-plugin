 ...
 */
namespace Wordlift\Modules\Common\Symfony\Component\Config\Util;

use Wordlift\Modules\Common\Symfony\Component\Config\Util\Exception\InvalidXmlException;
use Wordlift\Modules\Common\Symfony\Component\Config\Util\Exception\XmlParsingException;
/**
...
class XmlUtils {
	...
	public static function convertDomElementToArray( \DOMElement $element, $checkPrefix = \true ) {
		...
		foreach ( $element->attributes as $name => $node ) {
			if ( $checkPrefix && ! \in_array( (string) $node->prefix, array( '', $prefix ), \true ) ) {
				continue;
			}
