...
.directive('wlEntityForm', ['configuration', '$window', '$log', (configuration, $window, $log)->
    ...
    scope:
      ...
      box: '='
    templateUrl: ()->
      configuration.defaultWordLiftPath + 'templates/wordlift-widget-be/wordlift-directive-entity-form.html?ver=3.24.1'
...
.directive('wlEntityInputBox', ['configuration', '$log', (configuration, $log)->
    ...
    scope:
      entity: '='
    templateUrl: ()->
      configuration.defaultWordLiftPath + 'templates/wordlift-widget-be/wordlift-directive-entity-input-box.html?ver=3.24.1'
])
