...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/mappings/edit-mappings.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*!*****************************************************************!*\
  !*** ./node_modules/@reduxjs/toolkit/dist/redux-toolkit.esm.js ***!
  \*****************************************************************/
/*! exports provided: createNextState, current, freeze, __DO_NOT_USE__ActionTypes, applyMiddleware, bindActionCreators, combineReducers, compose, createStore, createSelector, MiddlewareArray, configureStore, createAction, createAsyncThunk, createDraftSafeSelector, createEntityAdapter, createImmutableStateInvariantMiddleware, createReducer, createSerializableStateInvariantMiddleware, createSlice, findNonSerializableValue, getDefaultMiddleware, getType, isAllOf, isAnyOf, isAsyncThunkAction, isFulfilled, isImmutableDefault, isPending, isPlain, isPlainObject, isRejected, isRejectedWithValue, nanoid, unwrapResult */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var reselect__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! reselect */ "./node_modules/@reduxjs/toolkit/node_modules/reselect/es/index.js");
...
/***/ "./src/mappings/actions/action-types.js":
/*!**********************************************!*\
  !*** ./src/mappings/actions/action-types.js ***!
  \**********************************************/
/*! exports provided: ADD_NEW_RULE, ADD_NEW_RULE_GROUP, DELETE_RULE, CHANGE_RULE_FIELD_VALUE, OPEN_OR_CLOSE_PROPERTY, PROPERTY_DATA_CHANGED, ADD_MAPPING, TITLE_CHANGED, PROPERTY_LIST_CHANGED, RULE_GROUP_LIST_CHANGED, MAPPING_HEADER_CHANGED, NOTIFICATION_CHANGED, MAPPING_LIST_CHANGED, MAPPING_LIST_SORT_TITLE_CHANGED, MAPPING_ITEM_CATEGORY_CHANGED, MAPPING_LIST_BULK_SELECT, MAPPING_LIST_CHOOSEN_CATEGORY_CHANGED, MAPPING_ITEM_SELECTED, PROPERTY_ITEM_CATEGORY_CHANGED, PROPERTY_LIST_SELECTED_CATEGORY_CHANGED, PROPERTY_ITEM_CRUD_OPERATION, BULK_ACTION_SELECTION_CHANGED, PROPERTY_ITEM_SELECTED, PROPERTY_ITEM_SELECT_ALL, PROPERTY_ITEMS_BULK_SELECT, EDIT_MAPPING_REQUEST_TERMS, EDIT_MAPPING_TERMS_FETCHED_FOR_TAXONOMY, EDIT_MAPPING_SAVE_MAPPING_ITEM, EDIT_MAPPING_REQUEST_MAPPING_ITEM, MAPPING_ITEMS_BULK_APPLY, MAPPING_ID_CHANGED_FROM_API, MAPPING_TERMS_CHANGED, MAPPINGS_REQUEST, MAPPINGS_REQUEST_DELETE_OR_UPDATE, MAPPINGS_REQUEST_CLONE_MAPPINGS, MAPPINGS_RESET_UI_AFTER_BULK_APPLY */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ADD_NEW_RULE", function() { return ADD_NEW_RULE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ADD_NEW_RULE_GROUP", function() { return ADD_NEW_RULE_GROUP; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DELETE_RULE", function() { return DELETE_RULE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CHANGE_RULE_FIELD_VALUE", function() { return CHANGE_RULE_FIELD_VALUE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OPEN_OR_CLOSE_PROPERTY", function() { return OPEN_OR_CLOSE_PROPERTY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PROPERTY_DATA_CHANGED", function() { return PROPERTY_DATA_CHANGED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ADD_MAPPING", function() { return ADD_MAPPING; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TITLE_CHANGED", function() { return TITLE_CHANGED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PROPERTY_LIST_CHANGED", function() { return PROPERTY_LIST_CHANGED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RULE_GROUP_LIST_CHANGED", function() { return RULE_GROUP_LIST_CHANGED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPING_HEADER_CHANGED", function() { return MAPPING_HEADER_CHANGED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NOTIFICATION_CHANGED", function() { return NOTIFICATION_CHANGED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPING_LIST_CHANGED", function() { return MAPPING_LIST_CHANGED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPING_LIST_SORT_TITLE_CHANGED", function() { return MAPPING_LIST_SORT_TITLE_CHANGED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPING_ITEM_CATEGORY_CHANGED", function() { return MAPPING_ITEM_CATEGORY_CHANGED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPING_LIST_BULK_SELECT", function() { return MAPPING_LIST_BULK_SELECT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPING_LIST_CHOOSEN_CATEGORY_CHANGED", function() { return MAPPING_LIST_CHOOSEN_CATEGORY_CHANGED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPING_ITEM_SELECTED", function() { return MAPPING_ITEM_SELECTED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PROPERTY_ITEM_CATEGORY_CHANGED", function() { return PROPERTY_ITEM_CATEGORY_CHANGED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PROPERTY_LIST_SELECTED_CATEGORY_CHANGED", function() { return PROPERTY_LIST_SELECTED_CATEGORY_CHANGED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PROPERTY_ITEM_CRUD_OPERATION", function() { return PROPERTY_ITEM_CRUD_OPERATION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BULK_ACTION_SELECTION_CHANGED", function() { return BULK_ACTION_SELECTION_CHANGED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PROPERTY_ITEM_SELECTED", function() { return PROPERTY_ITEM_SELECTED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PROPERTY_ITEM_SELECT_ALL", function() { return PROPERTY_ITEM_SELECT_ALL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PROPERTY_ITEMS_BULK_SELECT", function() { return PROPERTY_ITEMS_BULK_SELECT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EDIT_MAPPING_REQUEST_TERMS", function() { return EDIT_MAPPING_REQUEST_TERMS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EDIT_MAPPING_TERMS_FETCHED_FOR_TAXONOMY", function() { return EDIT_MAPPING_TERMS_FETCHED_FOR_TAXONOMY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EDIT_MAPPING_SAVE_MAPPING_ITEM", function() { return EDIT_MAPPING_SAVE_MAPPING_ITEM; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EDIT_MAPPING_REQUEST_MAPPING_ITEM", function() { return EDIT_MAPPING_REQUEST_MAPPING_ITEM; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPING_ITEMS_BULK_APPLY", function() { return MAPPING_ITEMS_BULK_APPLY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPING_ID_CHANGED_FROM_API", function() { return MAPPING_ID_CHANGED_FROM_API; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPING_TERMS_CHANGED", function() { return MAPPING_TERMS_CHANGED; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPINGS_REQUEST", function() { return MAPPINGS_REQUEST; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPINGS_REQUEST_DELETE_OR_UPDATE", function() { return MAPPINGS_REQUEST_DELETE_OR_UPDATE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPINGS_REQUEST_CLONE_MAPPINGS", function() { return MAPPINGS_REQUEST_CLONE_MAPPINGS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPINGS_RESET_UI_AFTER_BULK_APPLY", function() { return MAPPINGS_RESET_UI_AFTER_BULK_APPLY; });
/**
...
const MAPPINGS_RESET_UI_AFTER_BULK_APPLY = "MAPPINGS_RESET_UI_AFTER_BULK_APPLY";

/***/ }),

/***/ "./src/mappings/actions/actions.js":
/*!*****************************************!*\
  !*** ./src/mappings/actions/actions.js ***!
  \*****************************************/
/*! exports provided: ADD_NEW_RULE_ACTION, ADD_NEW_RULE_GROUP_ACTION, DELETE_RULE_ACTION, CHANGE_RULE_FIELD_VALUE_ACTION, OPEN_OR_CLOSE_PROPERTY_ACTION, PROPERTY_DATA_CHANGED_ACTION, ADD_MAPPING_ACTION, TITLE_CHANGED_ACTION, PROPERTY_LIST_CHANGED_ACTION, RULE_GROUP_LIST_CHANGED_ACTION, MAPPING_HEADER_CHANGED_ACTION, NOTIFICATION_CHANGED_ACTION, MAPPING_LIST_CHANGED_ACTION, MAPPING_ITEM_CATEGORY_CHANGED_ACTION, MAPPING_LIST_BULK_SELECT_ACTION, MAPPING_LIST_CHOOSEN_CATEGORY_CHANGED_ACTION, MAPPING_ITEM_SELECTED_ACTION, MAPPING_LIST_SORT_TITLE_CHANGED_ACTION, PROPERTY_ITEM_CATEGORY_CHANGED_ACTION, PROPERTY_LIST_CHOOSEN_CATEGORY_CHANGED_ACTION, PROPERTY_ITEM_CRUD_OPERATION_ACTION, BULK_ACTION_SELECTION_CHANGED_ACTION, PROPERTY_ITEM_SELECTED_ACTION, PROPERTY_ITEM_SELECT_ALL_ACTION, PROPERTY_ITEMS_BULK_ACTION, MAPPING_ITEMS_BULK_APPLY_ACTION, EDIT_MAPPING_REQUEST_TERMS_ACTION, EDIT_MAPPING_TERMS_FETCHED_FOR_TAXONOMY_ACTION, EDIT_MAPPING_SAVE_MAPPING_ITEM_ACTION, EDIT_MAPPING_REQUEST_MAPPING_ITEM_ACTION, MAPPING_ID_CHANGED_FROM_API_ACTION, MAPPING_TERMS_CHANGED_ACTION, MAPPINGS_REQUEST_ACTION, MAPPINGS_REQUEST_DELETE_OR_UPDATE_ACTION, MAPPINGS_REQUEST_CLONE_MAPPINGS_ACTION, MAPPINGS_RESET_UI_AFTER_BULK_APPLY_ACTION */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ADD_NEW_RULE_ACTION", function() { return ADD_NEW_RULE_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ADD_NEW_RULE_GROUP_ACTION", function() { return ADD_NEW_RULE_GROUP_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DELETE_RULE_ACTION", function() { return DELETE_RULE_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CHANGE_RULE_FIELD_VALUE_ACTION", function() { return CHANGE_RULE_FIELD_VALUE_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OPEN_OR_CLOSE_PROPERTY_ACTION", function() { return OPEN_OR_CLOSE_PROPERTY_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PROPERTY_DATA_CHANGED_ACTION", function() { return PROPERTY_DATA_CHANGED_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ADD_MAPPING_ACTION", function() { return ADD_MAPPING_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TITLE_CHANGED_ACTION", function() { return TITLE_CHANGED_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PROPERTY_LIST_CHANGED_ACTION", function() { return PROPERTY_LIST_CHANGED_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RULE_GROUP_LIST_CHANGED_ACTION", function() { return RULE_GROUP_LIST_CHANGED_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPING_HEADER_CHANGED_ACTION", function() { return MAPPING_HEADER_CHANGED_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NOTIFICATION_CHANGED_ACTION", function() { return NOTIFICATION_CHANGED_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPING_LIST_CHANGED_ACTION", function() { return MAPPING_LIST_CHANGED_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPING_ITEM_CATEGORY_CHANGED_ACTION", function() { return MAPPING_ITEM_CATEGORY_CHANGED_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPING_LIST_BULK_SELECT_ACTION", function() { return MAPPING_LIST_BULK_SELECT_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPING_LIST_CHOOSEN_CATEGORY_CHANGED_ACTION", function() { return MAPPING_LIST_CHOOSEN_CATEGORY_CHANGED_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPING_ITEM_SELECTED_ACTION", function() { return MAPPING_ITEM_SELECTED_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPING_LIST_SORT_TITLE_CHANGED_ACTION", function() { return MAPPING_LIST_SORT_TITLE_CHANGED_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PROPERTY_ITEM_CATEGORY_CHANGED_ACTION", function() { return PROPERTY_ITEM_CATEGORY_CHANGED_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PROPERTY_LIST_CHOOSEN_CATEGORY_CHANGED_ACTION", function() { return PROPERTY_LIST_CHOOSEN_CATEGORY_CHANGED_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PROPERTY_ITEM_CRUD_OPERATION_ACTION", function() { return PROPERTY_ITEM_CRUD_OPERATION_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BULK_ACTION_SELECTION_CHANGED_ACTION", function() { return BULK_ACTION_SELECTION_CHANGED_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PROPERTY_ITEM_SELECTED_ACTION", function() { return PROPERTY_ITEM_SELECTED_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PROPERTY_ITEM_SELECT_ALL_ACTION", function() { return PROPERTY_ITEM_SELECT_ALL_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PROPERTY_ITEMS_BULK_ACTION", function() { return PROPERTY_ITEMS_BULK_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPING_ITEMS_BULK_APPLY_ACTION", function() { return MAPPING_ITEMS_BULK_APPLY_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EDIT_MAPPING_REQUEST_TERMS_ACTION", function() { return EDIT_MAPPING_REQUEST_TERMS_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EDIT_MAPPING_TERMS_FETCHED_FOR_TAXONOMY_ACTION", function() { return EDIT_MAPPING_TERMS_FETCHED_FOR_TAXONOMY_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EDIT_MAPPING_SAVE_MAPPING_ITEM_ACTION", function() { return EDIT_MAPPING_SAVE_MAPPING_ITEM_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EDIT_MAPPING_REQUEST_MAPPING_ITEM_ACTION", function() { return EDIT_MAPPING_REQUEST_MAPPING_ITEM_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPING_ID_CHANGED_FROM_API_ACTION", function() { return MAPPING_ID_CHANGED_FROM_API_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPING_TERMS_CHANGED_ACTION", function() { return MAPPING_TERMS_CHANGED_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPINGS_REQUEST_ACTION", function() { return MAPPINGS_REQUEST_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPINGS_REQUEST_DELETE_OR_UPDATE_ACTION", function() { return MAPPINGS_REQUEST_DELETE_OR_UPDATE_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPINGS_REQUEST_CLONE_MAPPINGS_ACTION", function() { return MAPPINGS_REQUEST_CLONE_MAPPINGS_ACTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAPPINGS_RESET_UI_AFTER_BULK_APPLY_ACTION", function() { return MAPPINGS_RESET_UI_AFTER_BULK_APPLY_ACTION; });
/* harmony import */ var _action_types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./action-types */ "./src/mappings/actions/action-types.js");
/**
...
const ADD_NEW_RULE_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["ADD_NEW_RULE"]
};
/**
...
const ADD_NEW_RULE_GROUP_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["ADD_NEW_RULE_GROUP"]
};
/**
...
const DELETE_RULE_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["DELETE_RULE"]
};
/**
...
const CHANGE_RULE_FIELD_VALUE_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["CHANGE_RULE_FIELD_VALUE"]
};
/**
...
const OPEN_OR_CLOSE_PROPERTY_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["OPEN_OR_CLOSE_PROPERTY"]
};
/**
...
const PROPERTY_DATA_CHANGED_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["PROPERTY_DATA_CHANGED"]
};
/**
...
const ADD_MAPPING_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["ADD_MAPPING"]
};
/**
...
const TITLE_CHANGED_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["TITLE_CHANGED"]
};
/**
...
const PROPERTY_LIST_CHANGED_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["PROPERTY_LIST_CHANGED"]
};
/**
...
const RULE_GROUP_LIST_CHANGED_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["RULE_GROUP_LIST_CHANGED"]
};
/**
...
const MAPPING_HEADER_CHANGED_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["MAPPING_HEADER_CHANGED"]
};
/**
...
const NOTIFICATION_CHANGED_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["NOTIFICATION_CHANGED"]
};
/**
...
const MAPPING_LIST_CHANGED_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["MAPPING_LIST_CHANGED"]
};
/**
...
const MAPPING_ITEM_CATEGORY_CHANGED_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["MAPPING_ITEM_CATEGORY_CHANGED"]
};
/**
...
const MAPPING_LIST_BULK_SELECT_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["MAPPING_LIST_BULK_SELECT"]
};
/**
...
const MAPPING_LIST_CHOOSEN_CATEGORY_CHANGED_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["MAPPING_LIST_CHOOSEN_CATEGORY_CHANGED"]
};
/**
 * @const {object} MAPPING_LIST_CHOOSEN_CATEGORY_CHANGED_ACTION
...
const MAPPING_ITEM_SELECTED_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["MAPPING_ITEM_SELECTED"]
};
/**
...
const MAPPING_LIST_SORT_TITLE_CHANGED_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["MAPPING_LIST_SORT_TITLE_CHANGED"]
};
/**
...
const PROPERTY_ITEM_CATEGORY_CHANGED_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["PROPERTY_ITEM_CATEGORY_CHANGED"]
};
/**
...
const PROPERTY_LIST_CHOOSEN_CATEGORY_CHANGED_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["PROPERTY_LIST_SELECTED_CATEGORY_CHANGED"]
};
/**
...
const PROPERTY_ITEM_CRUD_OPERATION_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["PROPERTY_ITEM_CRUD_OPERATION"]
};
/**
...
const BULK_ACTION_SELECTION_CHANGED_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["BULK_ACTION_SELECTION_CHANGED"]
};
/**
...
const PROPERTY_ITEM_SELECTED_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["PROPERTY_ITEM_SELECTED"]
};
/**
...
const PROPERTY_ITEM_SELECT_ALL_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["PROPERTY_ITEM_SELECT_ALL"]
};
/**
...
const PROPERTY_ITEMS_BULK_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["PROPERTY_ITEMS_BULK_SELECT"]
};
/**
...
const MAPPING_ITEMS_BULK_APPLY_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["MAPPING_ITEMS_BULK_APPLY"]
};
/**
...
const EDIT_MAPPING_REQUEST_TERMS_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["EDIT_MAPPING_REQUEST_TERMS"]
};
/**
...
const EDIT_MAPPING_TERMS_FETCHED_FOR_TAXONOMY_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["EDIT_MAPPING_TERMS_FETCHED_FOR_TAXONOMY"]
};
/**
...
const EDIT_MAPPING_SAVE_MAPPING_ITEM_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["EDIT_MAPPING_SAVE_MAPPING_ITEM"]
};
/**
...
const EDIT_MAPPING_REQUEST_MAPPING_ITEM_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["EDIT_MAPPING_REQUEST_MAPPING_ITEM"]
};
/**
...
const MAPPING_ID_CHANGED_FROM_API_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["MAPPING_ID_CHANGED_FROM_API"]
};
/**
...
const MAPPING_TERMS_CHANGED_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["MAPPING_TERMS_CHANGED"]
};
/**
...
const MAPPINGS_REQUEST_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["MAPPINGS_REQUEST"]
};
/**
...
const MAPPINGS_REQUEST_DELETE_OR_UPDATE_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["MAPPINGS_REQUEST_DELETE_OR_UPDATE"]
};
/**
...
const MAPPINGS_REQUEST_CLONE_MAPPINGS_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["MAPPINGS_REQUEST_CLONE_MAPPINGS"]
};
/**
...
const MAPPINGS_RESET_UI_AFTER_BULK_APPLY_ACTION = {
  type: _action_types__WEBPACK_IMPORTED_MODULE_0__["MAPPINGS_RESET_UI_AFTER_BULK_APPLY"]
};

/***/ }),

/***/ "./src/mappings/api/edit-mapping-api.js":
/*!**********************************************!*\
  !*** ./src/mappings/api/edit-mapping-api.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var _filters_edit_component_filters__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../filters/edit-component-filters */ "./src/mappings/filters/edit-component-filters.js");
/**
...
function saveMappingItem(mappingData) {
  const postObject = _filters_edit_component_filters__WEBPACK_IMPORTED_MODULE_0__["default"].mapStoreKeysToAPI(mappingData);
...
/***/ "./src/mappings/blocks/wl-table/index.js":
/*!***********************************************!*\
  !*** ./src/mappings/blocks/wl-table/index.js ***!
  \***********************************************/
/*! exports provided: WlTable */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WlTable", function() { return WlTable; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.scss */ "./src/mappings/blocks/wl-table/index.scss");
/* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_index_scss__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../helper */ "./src/mappings/blocks/helper.js");
/**
...
/***/ "./src/mappings/blocks/wl-table/index.scss":
/*!*************************************************!*\
  !*** ./src/mappings/blocks/wl-table/index.scss ***!
  \*************************************************/
/*! no static exports found */
...
/***/ "./src/mappings/components/bulk-action-component.js":
/*!**********************************************************!*\
  !*** ./src/mappings/components/bulk-action-component.js ***!
  \**********************************************************/
/*! exports provided: default */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _bulk_action_sub_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./bulk-action-sub-components */ "./src/mappings/components/bulk-action-sub-components.js");
/* harmony import */ var _blocks_wl_column__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../blocks/wl-column */ "./src/mappings/blocks/wl-column/index.js");
/**
...
const BulkActionApplyButton = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blocks_wl_column__WEBPACK_IMPORTED_MODULE_2__["WlColumn"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
...
const BulkActionOptionsWrapper = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blocks_wl_column__WEBPACK_IMPORTED_MODULE_2__["WlColumn"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("select", {
    ...
    value: "-1"
  }, "Bulk Actions"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_bulk_action_sub_components__WEBPACK_IMPORTED_MODULE_1__["BulkActionOptions"], {
...
/* harmony default export */ __webpack_exports__["default"] = (BulkActionComponent);

/***/ }),

/***/ "./src/mappings/components/bulk-action-sub-components.js":
/*!***************************************************************!*\
  !*** ./src/mappings/components/bulk-action-sub-components.js ***!
  \***************************************************************/
/*! exports provided: BULK_OPTIONS, BulkActionOptions */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BULK_OPTIONS", function() { return BULK_OPTIONS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BulkActionOptions", function() { return BulkActionOptions; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _category_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./category-component */ "./src/mappings/components/category-component.js");
/**
...
const BulkActionOptions = props => {
  switch (props.chosenCategory) {
    case _category_component__WEBPACK_IMPORTED_MODULE_1__["TRASH_CATEGORY"]:
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(TrashOptions, null);

    case _category_component__WEBPACK_IMPORTED_MODULE_1__["ACTIVE_CATEGORY"]:
...
/***/ "./src/mappings/components/category-component.js":
/*!*******************************************************!*\
  !*** ./src/mappings/components/category-component.js ***!
  \*******************************************************/
/*! exports provided: TRASH_CATEGORY, ACTIVE_CATEGORY, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TRASH_CATEGORY", function() { return TRASH_CATEGORY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ACTIVE_CATEGORY", function() { return ACTIVE_CATEGORY; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
/***/ "./src/mappings/components/edit-mapping-component/add-rule-button.js":
/*!***************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/add-rule-button.js ***!
  \***************************************************************************/
/*! exports provided: AddRuleButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddRuleButton", function() { return AddRuleButton; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _actions_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../actions/actions */ "./src/mappings/actions/actions.js");
/* harmony import */ var _blocks_wl_column__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../blocks/wl-column */ "./src/mappings/blocks/wl-column/index.js");
/**
...
class _AddRuleButton extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
  ...
  handleAddNewRule(ruleGroupIndex, ruleIndex) {
    const action = _actions_actions__WEBPACK_IMPORTED_MODULE_2__["ADD_NEW_RULE_ACTION"];
    action.payload = {
  ...
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blocks_wl_column__WEBPACK_IMPORTED_MODULE_3__["WlColumn"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
...
const AddRuleButton = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])()(_AddRuleButton);

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/add-rule-group-button.js":
/*!*********************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/add-rule-group-button.js ***!
  \*********************************************************************************/
/*! exports provided: AddRuleGroupButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddRuleGroupButton", function() { return AddRuleGroupButton; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _actions_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../actions/actions */ "./src/mappings/actions/actions.js");
/* harmony import */ var _blocks_wl_column__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../blocks/wl-column */ "./src/mappings/blocks/wl-column/index.js");
/* harmony import */ var _blocks_wl_container__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../blocks/wl-container */ "./src/mappings/blocks/wl-container/index.js");
/**
...
class _AddRuleGroupButton extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
  ...
  addNewRuleGroupHandler() {
    this.props.dispatch(_actions_actions__WEBPACK_IMPORTED_MODULE_2__["ADD_NEW_RULE_GROUP_ACTION"]);
  }

  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blocks_wl_container__WEBPACK_IMPORTED_MODULE_4__["WlContainer"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blocks_wl_column__WEBPACK_IMPORTED_MODULE_3__["WlColumn"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
...
const AddRuleGroupButton = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])()(_AddRuleGroupButton);

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/delete-rule-button.js":
/*!******************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/delete-rule-button.js ***!
  \******************************************************************************/
/*! exports provided: DeleteRuleButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DeleteRuleButton", function() { return DeleteRuleButton; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _actions_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../actions/actions */ "./src/mappings/actions/actions.js");
...
class _DeleteRuleButton extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
  ...
  handleDeleteRule(ruleGroupIndex, ruleIndex) {
    const action = _actions_actions__WEBPACK_IMPORTED_MODULE_2__["DELETE_RULE_ACTION"];
    action.payload = {
      ruleGroupIndex: ruleGroupIndex,
      ruleIndex: ruleIndex
    };
  ...
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, (0 !== this.props.ruleGroupIndex || 0 !== this.props.ruleIndex) && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blocks_wl_column__WEBPACK_IMPORTED_MODULE_3__["WlColumn"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
...
const DeleteRuleButton = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])()(_DeleteRuleButton);

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/edit-mapping-property-bulk-action.js":
/*!*********************************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/edit-mapping-property-bulk-action.js ***!
  \*********************************************************************************************/
/*! exports provided: EditMappingPropertyBulkAction */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditMappingPropertyBulkAction", function() { return EditMappingPropertyBulkAction; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _bulk_action_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../bulk-action-component */ "./src/mappings/components/bulk-action-component.js");
/* harmony import */ var _actions_actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../actions/actions */ "./src/mappings/actions/actions.js");
/**
...
class _EditMappingPropertyBulkAction extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
  ...
  bulkActionSubmitHandler() {
    this.props.dispatch(_actions_actions__WEBPACK_IMPORTED_MODULE_3__["PROPERTY_ITEMS_BULK_ACTION"]);
  }

  bulkActionOptionChangedHandler(event) {
    const selectedBulkOption = event.target.value;
    _actions_actions__WEBPACK_IMPORTED_MODULE_3__["BULK_ACTION_SELECTION_CHANGED_ACTION"].payload = {
      selectedBulkAction: selectedBulkOption
    };
    this.props.dispatch(_actions_actions__WEBPACK_IMPORTED_MODULE_3__["BULK_ACTION_SELECTION_CHANGED_ACTION"]);
  }

  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_bulk_action_component__WEBPACK_IMPORTED_MODULE_2__["default"], {
      chosenCategory: this.props.chosenCategory,
...
const EditMappingPropertyBulkAction = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(state => ({
  chosenCategory: state.PropertyListData.chosenPropertyCategory
}))(_EditMappingPropertyBulkAction);

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/edit-mapping-save-button.js":
/*!************************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/edit-mapping-save-button.js ***!
  \************************************************************************************/
/*! exports provided: EditMappingSaveButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditMappingSaveButton", function() { return EditMappingSaveButton; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _actions_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../actions/actions */ "./src/mappings/actions/actions.js");
...
class _EditMappingSaveButton extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
  ...
  saveMappingItem() {
    _actions_actions__WEBPACK_IMPORTED_MODULE_2__["EDIT_MAPPING_SAVE_MAPPING_ITEM_ACTION"].payload = {
      mappingData: this.props.mappingData
    };
    this.props.dispatch(_actions_actions__WEBPACK_IMPORTED_MODULE_2__["EDIT_MAPPING_SAVE_MAPPING_ITEM_ACTION"]);
  }
...
const EditMappingSaveButton = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(state => ({
  mappingData: state,
...
/***/ "./src/mappings/components/edit-mapping-component/edit-mapping-title-section.js":
/*!**************************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/edit-mapping-title-section.js ***!
  \**************************************************************************************/
/*! exports provided: EditMappingTitleSection */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditMappingTitleSection", function() { return EditMappingTitleSection; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _actions_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../actions/actions */ "./src/mappings/actions/actions.js");
/* harmony import */ var _title_area__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./title-area */ "./src/mappings/components/edit-mapping-component/title-area.js");
/**
...
class _EditMappingTitleSection extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
  ...
  handleTitleChange(event) {
    _actions_actions__WEBPACK_IMPORTED_MODULE_2__["TITLE_CHANGED_ACTION"].payload = {
      value: event.target.value
    };
    this.props.dispatch(_actions_actions__WEBPACK_IMPORTED_MODULE_2__["TITLE_CHANGED_ACTION"]);
  }

  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_title_area__WEBPACK_IMPORTED_MODULE_3__["TitleArea"], {
...
const EditMappingTitleSection = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(state => ({
  title: state.TitleSectionData.title
}))(_EditMappingTitleSection);

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/index.js":
/*!*****************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/index.js ***!
  \*****************************************************************/
/*! exports provided: default */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _property_component_property_list_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./property-component/property-list-component */ "./src/mappings/components/edit-mapping-component/property-component/property-list-component.js");
/* harmony import */ var _actions_actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../actions/actions */ "./src/mappings/actions/actions.js");
/* harmony import */ var _rule_group_wrapper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./rule-group-wrapper */ "./src/mappings/components/edit-mapping-component/rule-group-wrapper.js");
/* harmony import */ var _edit_mapping_save_button__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./edit-mapping-save-button */ "./src/mappings/components/edit-mapping-component/edit-mapping-save-button.js");
/* harmony import */ var _edit_mapping_property_bulk_action__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./edit-mapping-property-bulk-action */ "./src/mappings/components/edit-mapping-component/edit-mapping-property-bulk-action.js");
/* harmony import */ var _edit_mapping_title_section__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./edit-mapping-title-section */ "./src/mappings/components/edit-mapping-component/edit-mapping-title-section.js");
/* harmony import */ var _notification_area__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./notification-area */ "./src/mappings/components/edit-mapping-component/notification-area.js");
/* harmony import */ var _blocks_wl_container__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../blocks/wl-container */ "./src/mappings/blocks/wl-container/index.js");
/**
...
class EditMappingComponent extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
  }
  ...
  getMappingItemByMappingId() {
    ...
    _actions_actions__WEBPACK_IMPORTED_MODULE_3__["EDIT_MAPPING_REQUEST_MAPPING_ITEM_ACTION"].payload = {
      mappingId: mappingId
    };
    this.props.dispatch(_actions_actions__WEBPACK_IMPORTED_MODULE_3__["EDIT_MAPPING_REQUEST_MAPPING_ITEM_ACTION"]);
  }

  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_notification_area__WEBPACK_IMPORTED_MODULE_8__["NotificationArea"], {
      notificationData: this.props.notificationData
    }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_edit_mapping_title_section__WEBPACK_IMPORTED_MODULE_7__["EditMappingTitleSection"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_rule_group_wrapper__WEBPACK_IMPORTED_MODULE_4__["RuleGroupWrapper"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_property_component_property_list_component__WEBPACK_IMPORTED_MODULE_2__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blocks_wl_container__WEBPACK_IMPORTED_MODULE_9__["WlContainer"], {
      fullWidth: true
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_edit_mapping_property_bulk_action__WEBPACK_IMPORTED_MODULE_6__["EditMappingPropertyBulkAction"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_edit_mapping_save_button__WEBPACK_IMPORTED_MODULE_5__["EditMappingSaveButton"], null)));
  }
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps)(EditMappingComponent));

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/notification-area.js":
/*!*****************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/notification-area.js ***!
  \*****************************************************************************/
/*! exports provided: NotificationArea */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NotificationArea", function() { return NotificationArea; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/**
...
const NotificationArea = ({
  notificationData
}) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, "" !== notificationData.message && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
  className: "wl-notice-custom-margin notice notice-" + notificationData.type + " is-dismissble"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, notificationData.message)));

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/property-component/add-property-button.js":
/*!**************************************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/property-component/add-property-button.js ***!
  \**************************************************************************************************/
/*! exports provided: AddPropertyButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddPropertyButton", function() { return AddPropertyButton; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _actions_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../actions/actions */ "./src/mappings/actions/actions.js");
...
class _AddPropertyButton extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
      ...
      onClick: () => {
        this.props.dispatch(_actions_actions__WEBPACK_IMPORTED_MODULE_2__["ADD_MAPPING_ACTION"]);
      }
    }, "Add Mapping"), " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null)));
  }

}

const AddPropertyButton = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])()(_AddPropertyButton);

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/property-component/field-name-field.js":
/*!***********************************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/property-component/field-name-field.js ***!
  \***********************************************************************************************/
/*! exports provided: FieldNameField */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FieldNameField", function() { return FieldNameField; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _actions_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../actions/actions */ "./src/mappings/actions/actions.js");
/* harmony import */ var _select_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../select-component */ "./src/mappings/components/select-component.js");
/* harmony import */ var _property_input_field__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./property-input-field */ "./src/mappings/components/edit-mapping-component/property-component/property-input-field.js");
/**
...
class _FieldNameField extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
  ...
  handleChangeForPropertyField(fieldKey, event) {
    _actions_actions__WEBPACK_IMPORTED_MODULE_2__["PROPERTY_DATA_CHANGED_ACTION"].payload = {
      fieldKey: fieldKey,
      value: event.target.value,
      propertyId: this.props.propData.property_id
    };
    this.props.dispatch(_actions_actions__WEBPACK_IMPORTED_MODULE_2__["PROPERTY_DATA_CHANGED_ACTION"]);
  }
  /**
  ...
  getInputFieldForFieldName() {
    ...
    if (Array.isArray(value)) {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_select_component__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_property_input_field__WEBPACK_IMPORTED_MODULE_4__["PropertyInputField"], {
  ...
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
      colSpan: "2"
    }, "Field Text"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
      colSpan: "3"
...
const FieldNameField = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])()(_FieldNameField);

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/property-component/field-type-field.js":
/*!***********************************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/property-component/field-type-field.js ***!
  \***********************************************************************************************/
/*! exports provided: FieldTypeField */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FieldTypeField", function() { return FieldTypeField; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _actions_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../actions/actions */ "./src/mappings/actions/actions.js");
...
class _FieldTypeField extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
      colSpan: "2"
    }, "Field Type"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
      colSpan: "3"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_select_component__WEBPACK_IMPORTED_MODULE_3__["default"], {
      className: "wl-table__select-field",
...
const FieldTypeField = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])()(_FieldTypeField);

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/property-component/index.js":
/*!************************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/property-component/index.js ***!
  \************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _property_name_field__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./property-name-field */ "./src/mappings/components/edit-mapping-component/property-component/property-name-field.js");
/* harmony import */ var _field_type_field__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./field-type-field */ "./src/mappings/components/edit-mapping-component/property-component/field-type-field.js");
/* harmony import */ var _field_name_field__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./field-name-field */ "./src/mappings/components/edit-mapping-component/property-component/field-name-field.js");
/* harmony import */ var _transform_function_field__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./transform-function-field */ "./src/mappings/components/edit-mapping-component/property-component/transform-function-field.js");
/* harmony import */ var _property_close_mapping_button__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./property-close-mapping-button */ "./src/mappings/components/edit-mapping-component/property-component/property-close-mapping-button.js");
/* harmony import */ var _blocks_wl_table__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../blocks/wl-table */ "./src/mappings/blocks/wl-table/index.js");
/**
...
class PropertyComponent extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
      className: "row-title"
    }, this.props.propData.propertyHelpText), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blocks_wl_table__WEBPACK_IMPORTED_MODULE_8__["WlTable"], {
      noBorder: true,
      paddingLeft: true,
      striped: false,
      transparentBg: true
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tbody", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_property_name_field__WEBPACK_IMPORTED_MODULE_3__["PropertyNameField"], this.props), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_field_type_field__WEBPACK_IMPORTED_MODULE_4__["FieldTypeField"], this.props), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_field_name_field__WEBPACK_IMPORTED_MODULE_5__["FieldNameField"], this.props), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_transform_function_field__WEBPACK_IMPORTED_MODULE_6__["TransformFunctionField"], this.props), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_property_close_mapping_button__WEBPACK_IMPORTED_MODULE_7__["PropertyCloseMappingButton"], this.props))));
  }
...
PropertyComponent.propTypes = {
  propertyData: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.object
};
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["connect"])(mapStateToProps)(PropertyComponent));

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/property-component/property-categories.js":
/*!**************************************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/property-component/property-categories.js ***!
  \**************************************************************************************************/
/*! exports provided: PropertyCategories */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _actions_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../actions/actions */ "./src/mappings/actions/actions.js");
/* harmony import */ var _category_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../category-component */ "./src/mappings/components/category-component.js");
/**
...
class _PropertyCategories extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
  ...
  categorySelectHandler(category) {
    const action = _actions_actions__WEBPACK_IMPORTED_MODULE_2__["PROPERTY_LIST_CHOOSEN_CATEGORY_CHANGED_ACTION"];
    action.payload = {
  ...
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_category_component__WEBPACK_IMPORTED_MODULE_3__["default"], {
...
const PropertyCategories = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])()(_PropertyCategories);

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/property-component/property-close-mapping-button.js":
/*!************************************************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/property-component/property-close-mapping-button.js ***!
  \************************************************************************************************************/
/*! exports provided: PropertyCloseMappingButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PropertyCloseMappingButton", function() { return PropertyCloseMappingButton; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/**
...
/***/ "./src/mappings/components/edit-mapping-component/property-component/property-header-row.js":
/*!**************************************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/property-component/property-header-row.js ***!
  \**************************************************************************************************/
/*! exports provided: PropertyHeaderRow */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PropertyHeaderRow", function() { return PropertyHeaderRow; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _actions_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../actions/actions */ "./src/mappings/actions/actions.js");
...
class _PropertyHeaderRow extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
  ...
  selectAllPropertyHandler() {
    this.props.dispatch(_actions_actions__WEBPACK_IMPORTED_MODULE_2__["PROPERTY_ITEM_SELECT_ALL_ACTION"]);
  }
  ...
  render() {
    ...
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b", null, "Property")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b", null, "Field"))));
  }

}

const PropertyHeaderRow = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])()(_PropertyHeaderRow);

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/property-component/property-input-field.js":
/*!***************************************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/property-component/property-input-field.js ***!
  \***************************************************************************************************/
/*! exports provided: PropertyInputField */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PropertyInputField", function() { return PropertyInputField; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/**
...
/***/ "./src/mappings/components/edit-mapping-component/property-component/property-item-active-options.js":
/*!***********************************************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/property-component/property-item-active-options.js ***!
  \***********************************************************************************************************/
/*! exports provided: PropertyItemActiveOptions */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PropertyItemActiveOptions", function() { return PropertyItemActiveOptions; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _category_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../category-component */ "./src/mappings/components/category-component.js");
/* harmony import */ var _property_list_item_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./property-list-item-component */ "./src/mappings/components/edit-mapping-component/property-component/property-list-item-component.js");
/**
...
const PropertyItemActiveOptions = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_property_list_item_component__WEBPACK_IMPORTED_MODULE_2__["RowActionItem"], {
    className: "edit wl-mappings-link",
    onClickHandler: switchState,
    title: "Edit",
    args: [propData.property_id]
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_property_list_item_component__WEBPACK_IMPORTED_MODULE_2__["RowActionItem"], {
    className: "wl-mappings-link",
    onClickHandler: makeCrudOperationOnPropertyId,
    title: "Duplicate",
    args: [propData.property_id, _property_list_item_component__WEBPACK_IMPORTED_MODULE_2__["DUPLICATE_PROPERTY"]]
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_property_list_item_component__WEBPACK_IMPORTED_MODULE_2__["RowActionItem"], {
    className: "wl-mappings-link trash",
    onClickHandler: changeCategoryPropertyItem,
    title: "Trash",
    args: [propData.property_id, _category_component__WEBPACK_IMPORTED_MODULE_1__["TRASH_CATEGORY"]]
  }));
};

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/property-component/property-item-checkbox.js":
/*!*****************************************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/property-component/property-item-checkbox.js ***!
  \*****************************************************************************************************/
/*! exports provided: PropertyItemCheckbox */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PropertyItemCheckbox", function() { return PropertyItemCheckbox; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _actions_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../actions/actions */ "./src/mappings/actions/actions.js");
...
class _PropertyItemCheckbox extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
  ...
  propertySelectedHandler(propertyId) {
    const action = _actions_actions__WEBPACK_IMPORTED_MODULE_2__["PROPERTY_ITEM_SELECTED_ACTION"];
    action.payload = {
...
const PropertyItemCheckbox = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])()(_PropertyItemCheckbox);

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/property-component/property-item-trash-options.js":
/*!**********************************************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/property-component/property-item-trash-options.js ***!
  \**********************************************************************************************************/
/*! exports provided: PropertyItemTrashOptions */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PropertyItemTrashOptions", function() { return PropertyItemTrashOptions; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _category_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../category-component */ "./src/mappings/components/category-component.js");
/* harmony import */ var _property_list_item_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./property-list-item-component */ "./src/mappings/components/edit-mapping-component/property-component/property-list-item-component.js");
...
const PropertyItemTrashOptions = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_property_list_item_component__WEBPACK_IMPORTED_MODULE_2__["RowActionItem"], {
    ...
    onClickHandler: changeCategoryPropertyItem,
    title: "Restore",
    args: [propData.property_id, _category_component__WEBPACK_IMPORTED_MODULE_1__["ACTIVE_CATEGORY"]]
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_property_list_item_component__WEBPACK_IMPORTED_MODULE_2__["RowActionItem"], {
    className: "trash wl-mappings-link",
    onClickHandler: makeCrudOperationOnPropertyId,
    title: "Delete Permanently",
    args: [propData.property_id, _property_list_item_component__WEBPACK_IMPORTED_MODULE_2__["DELETE_PROPERTY_PERMANENT"]]
  }));
};

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/property-component/property-list-component.js":
/*!******************************************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/property-component/property-list-component.js ***!
  \******************************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! prop-types */ "./node_modules/prop-types/index.js");
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index */ "./src/mappings/components/edit-mapping-component/property-component/index.js");
/* harmony import */ var _property_list_item_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./property-list-item-component */ "./src/mappings/components/edit-mapping-component/property-component/property-list-item-component.js");
/* harmony import */ var _actions_actions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../actions/actions */ "./src/mappings/actions/actions.js");
/* harmony import */ var _add_property_button__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./add-property-button */ "./src/mappings/components/edit-mapping-component/property-component/add-property-button.js");
/* harmony import */ var _property_categories__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./property-categories */ "./src/mappings/components/edit-mapping-component/property-component/property-categories.js");
/* harmony import */ var _property_header_row__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./property-header-row */ "./src/mappings/components/edit-mapping-component/property-component/property-header-row.js");
/* harmony import */ var _property_no_item_message__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./property-no-item-message */ "./src/mappings/components/edit-mapping-component/property-component/property-no-item-message.js");
/* harmony import */ var _property_item_checkbox__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./property-item-checkbox */ "./src/mappings/components/edit-mapping-component/property-component/property-item-checkbox.js");
/* harmony import */ var _blocks_wl_container__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../blocks/wl-container */ "./src/mappings/blocks/wl-container/index.js");
/* harmony import */ var _blocks_wl_table__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../blocks/wl-table */ "./src/mappings/blocks/wl-table/index.js");
/**
...
class PropertyListComponent extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
  ...
  switchState(propertyId) {
    const action = _actions_actions__WEBPACK_IMPORTED_MODULE_5__["OPEN_OR_CLOSE_PROPERTY_ACTION"];
    action.payload = {
      propertyId: propertyId
    };
    this.props.dispatch(action);
  ...
  renderListComponentBasedOnState(property, index) {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_property_list_item_component__WEBPACK_IMPORTED_MODULE_4__["default"], {
      chosenCategory: this.props.chosenCategory,
      propData: property,
      switchState: this.switchState
    });
  ...
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_property_categories__WEBPACK_IMPORTED_MODULE_7__["PropertyCategories"], this.props), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blocks_wl_container__WEBPACK_IMPORTED_MODULE_11__["WlContainer"], {
      fullWidth: true
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blocks_wl_table__WEBPACK_IMPORTED_MODULE_12__["WlTable"], {
      bottomAligned: false
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_property_header_row__WEBPACK_IMPORTED_MODULE_8__["PropertyHeaderRow"], this.props), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tbody", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_property_no_item_message__WEBPACK_IMPORTED_MODULE_9__["PropertyNoItemMessage"], this.props), this.props.propertyList.filter(property => property.propertyStatus === this.props.chosenCategory).map((property, index) => {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
        key: index,
        className: "wl-property-list-item-container"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_property_item_checkbox__WEBPACK_IMPORTED_MODULE_10__["PropertyItemCheckbox"], {
        property: property
      }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, this.renderListComponentBasedOnState(property, index)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null));
    }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_add_property_button__WEBPACK_IMPORTED_MODULE_6__["AddPropertyButton"], null)))));
  }

}

PropertyListComponent.propTypes = {
  propertyList: prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.array
};
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps)(PropertyListComponent));

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/property-component/property-list-item-component.js":
/*!***********************************************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/property-component/property-list-item-component.js ***!
  \***********************************************************************************************************/
/*! exports provided: DUPLICATE_PROPERTY, DELETE_PROPERTY_PERMANENT, RowActionItem, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DUPLICATE_PROPERTY", function() { return DUPLICATE_PROPERTY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DELETE_PROPERTY_PERMANENT", function() { return DELETE_PROPERTY_PERMANENT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RowActionItem", function() { return RowActionItem; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! prop-types */ "./node_modules/prop-types/index.js");
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _actions_actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../actions/actions */ "./src/mappings/actions/actions.js");
/* harmony import */ var _category_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../category-component */ "./src/mappings/components/category-component.js");
/* harmony import */ var _property_item_active_options__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./property-item-active-options */ "./src/mappings/components/edit-mapping-component/property-component/property-item-active-options.js");
/* harmony import */ var _property_item_trash_options__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./property-item-trash-options */ "./src/mappings/components/edit-mapping-component/property-component/property-item-trash-options.js");
/* harmony import */ var _blocks_wl_column__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../blocks/wl-column */ "./src/mappings/blocks/wl-column/index.js");
/* harmony import */ var _blocks_wl_container__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../blocks/wl-container */ "./src/mappings/blocks/wl-container/index.js");
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
class PropertyListItemComponent extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
  ...
  renderOptionsBasedOnItemCategory(category) {
    switch (category) {
      case _category_component__WEBPACK_IMPORTED_MODULE_4__["ACTIVE_CATEGORY"]:
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_property_item_active_options__WEBPACK_IMPORTED_MODULE_5__["PropertyItemActiveOptions"], _extends({}, this.props, {
      ...
      case _category_component__WEBPACK_IMPORTED_MODULE_4__["TRASH_CATEGORY"]:
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_property_item_trash_options__WEBPACK_IMPORTED_MODULE_6__["PropertyItemTrashOptions"], _extends({}, this.props, {
          changeCategoryPropertyItem: this.changeCategoryPropertyItem,
          makeCrudOperationOnPropertyId: this.makeCrudOperationOnPropertyId
        }));
    }
  ...
  changeCategoryPropertyItem(propertyId, category) {
    _actions_actions__WEBPACK_IMPORTED_MODULE_3__["PROPERTY_ITEM_CATEGORY_CHANGED_ACTION"].payload = {
      propertyId: propertyId,
      propertyCategory: category
    };
    this.props.dispatch(_actions_actions__WEBPACK_IMPORTED_MODULE_3__["PROPERTY_ITEM_CATEGORY_CHANGED_ACTION"]);
  }

  makeCrudOperationOnPropertyId(propertyId, operationName) {
    const action = _actions_actions__WEBPACK_IMPORTED_MODULE_3__["PROPERTY_ITEM_CRUD_OPERATION_ACTION"];
    action.payload = {
      propertyId: propertyId,
  ...
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blocks_wl_container__WEBPACK_IMPORTED_MODULE_8__["WlContainer"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blocks_wl_column__WEBPACK_IMPORTED_MODULE_7__["WlColumn"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
      className: "row-title wl-property-list-item-title"
    }, this.props.propData.propertyHelpText), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
...
PropertyListItemComponent.propTypes = {
  propertyText: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string
};
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["connect"])()(PropertyListItemComponent));

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/property-component/property-name-field.js":
/*!**************************************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/property-component/property-name-field.js ***!
  \**************************************************************************************************/
/*! exports provided: PropertyNameField */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PropertyNameField", function() { return PropertyNameField; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _actions_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../actions/actions */ "./src/mappings/actions/actions.js");
/* harmony import */ var _property_input_field__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./property-input-field */ "./src/mappings/components/edit-mapping-component/property-component/property-input-field.js");
/**
...
class _PropertyNameField extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
      colSpan: "2"
    }, "Property Name"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
      colSpan: "3"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_property_input_field__WEBPACK_IMPORTED_MODULE_3__["PropertyInputField"], {
      propData: this.props.propData,
      handleChangeForPropertyField: (fieldKey, event) => {
        _actions_actions__WEBPACK_IMPORTED_MODULE_2__["PROPERTY_DATA_CHANGED_ACTION"].payload = {
          fieldKey: fieldKey,
...
const PropertyNameField = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])()(_PropertyNameField);

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/property-component/property-no-item-message.js":
/*!*******************************************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/property-component/property-no-item-message.js ***!
  \*******************************************************************************************************/
/*! exports provided: PropertyNoItemMessage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PropertyNoItemMessage", function() { return PropertyNoItemMessage; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _category_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../category-component */ "./src/mappings/components/category-component.js");
/**
...
const PropertyNoItemMessage = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, 0 === propertyList.filter(property => property.propertyStatus === chosenCategory).length && chosenCategory === _category_component__WEBPACK_IMPORTED_MODULE_1__["ACTIVE_CATEGORY"] && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
    colSpan: 2,
...
/***/ "./src/mappings/components/edit-mapping-component/property-component/transform-function-field.js":
/*!*******************************************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/property-component/transform-function-field.js ***!
  \*******************************************************************************************************/
/*! exports provided: TransformFunctionField */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TransformFunctionField", function() { return TransformFunctionField; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _actions_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../actions/actions */ "./src/mappings/actions/actions.js");
...
class _TransformFunctionField extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
      colSpan: "2"
    }, "Transform Function"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
      colSpan: "3"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_select_component__WEBPACK_IMPORTED_MODULE_3__["default"], {
      className: "wl-table__select-field",
...
const TransformFunctionField = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])()(_TransformFunctionField);

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/rule-component.js":
/*!**************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/rule-component.js ***!
  \**************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _select_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../select-component */ "./src/mappings/components/select-component.js");
/* harmony import */ var _actions_actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../actions/actions */ "./src/mappings/actions/actions.js");
/* harmony import */ var _add_rule_button__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./add-rule-button */ "./src/mappings/components/edit-mapping-component/add-rule-button.js");
/* harmony import */ var _delete_rule_button__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./delete-rule-button */ "./src/mappings/components/edit-mapping-component/delete-rule-button.js");
/* harmony import */ var _blocks_wl_column__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../blocks/wl-column */ "./src/mappings/blocks/wl-column/index.js");
/* harmony import */ var _blocks_wl_container__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../blocks/wl-container */ "./src/mappings/blocks/wl-container/index.js");
/* harmony import */ var _actions_action_types__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../actions/action-types */ "./src/mappings/actions/action-types.js");
/**
...
class RuleComponent extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
  ...
  handleSelectFieldChange(event, fieldKey) {
    const action = _actions_actions__WEBPACK_IMPORTED_MODULE_3__["CHANGE_RULE_FIELD_VALUE_ACTION"];
    action.payload = {
      value: event.target.value,
  ...
  getOptionsFromApiSource(selectedOptionValue) {
    ...
    this.props.dispatch({
      type: _actions_action_types__WEBPACK_IMPORTED_MODULE_8__["EDIT_MAPPING_REQUEST_TERMS"],
      payload: {
  ...
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blocks_wl_container__WEBPACK_IMPORTED_MODULE_7__["WlContainer"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blocks_wl_column__WEBPACK_IMPORTED_MODULE_6__["WlColumn"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_select_component__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blocks_wl_column__WEBPACK_IMPORTED_MODULE_6__["WlColumn"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_select_component__WEBPACK_IMPORTED_MODULE_2__["default"], {
      ...
      options: this.props.ruleFieldTwoOptions.filter(el => el.parentValue === this.props.ruleProps.ruleFieldOneValue),
    ...
    })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_add_rule_button__WEBPACK_IMPORTED_MODULE_4__["AddRuleButton"], this.props), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_delete_rule_button__WEBPACK_IMPORTED_MODULE_5__["DeleteRuleButton"], this.props));
  }
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps)(RuleComponent));

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/rule-group-component.js":
/*!********************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/rule-group-component.js ***!
  \********************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! prop-types */ "./node_modules/prop-types/index.js");
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _rule_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./rule-component */ "./src/mappings/components/edit-mapping-component/rule-component.js");
...
class RuleGroupComponent extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_rule_component__WEBPACK_IMPORTED_MODULE_2__["default"], {
        key: ruleIndex,
        ruleProps: ruleProps,
        ruleGroupIndex: this.props.ruleGroupIndex,
        ruleIndex: ruleIndex
...
RuleGroupComponent.propTypes = {
  rules: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.array
};
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_3__["connect"])(mapStateToProps)(RuleGroupComponent));

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/rule-group-list-component.js":
/*!*************************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/rule-group-list-component.js ***!
  \*************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _rule_group_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./rule-group-component */ "./src/mappings/components/edit-mapping-component/rule-group-component.js");
/* harmony import */ var _add_rule_group_button__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./add-rule-group-button */ "./src/mappings/components/edit-mapping-component/add-rule-group-button.js");
/* harmony import */ var _rule_group_text__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./rule-group-text */ "./src/mappings/components/edit-mapping-component/rule-group-text.js");
/* harmony import */ var _blocks_wl_column__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../blocks/wl-column */ "./src/mappings/blocks/wl-column/index.js");
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
class RuleGroupListComponent extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
  }

  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, 0 === this.props.ruleGroupList.length && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blocks_wl_column__WEBPACK_IMPORTED_MODULE_6__["WlColumn"], null, "No rule groups present, click on add new"), this.props.ruleGroupList.map((item, index) => {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, {
        key: index
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_rule_group_component__WEBPACK_IMPORTED_MODULE_3__["default"], {
        rules: item.rules,
        ruleGroupIndex: index
      }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_rule_group_text__WEBPACK_IMPORTED_MODULE_5__["RuleGroupText"], _extends({}, this.props, {
        index: index
      })));
    }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_add_rule_group_button__WEBPACK_IMPORTED_MODULE_4__["AddRuleGroupButton"], null));
  }

}

RuleGroupListComponent.propTypes = {
  ruleGroupList: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.array
};
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["connect"])(mapStateToProps)(RuleGroupListComponent));

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/rule-group-text.js":
/*!***************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/rule-group-text.js ***!
  \***************************************************************************/
/*! exports provided: RuleGroupText */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RuleGroupText", function() { return RuleGroupText; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _blocks_wl_column__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../blocks/wl-column */ "./src/mappings/blocks/wl-column/index.js");
/* harmony import */ var _blocks_wl_container__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../blocks/wl-container */ "./src/mappings/blocks/wl-container/index.js");
/**
...
const RuleGroupText = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, // dont show extra `or` text if there
  // is no rule group below
  index !== ruleGroupList.length - 1 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blocks_wl_container__WEBPACK_IMPORTED_MODULE_2__["WlContainer"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blocks_wl_column__WEBPACK_IMPORTED_MODULE_1__["WlColumn"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b", null, "Or"))));
};

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/rule-group-wrapper.js":
/*!******************************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/rule-group-wrapper.js ***!
  \******************************************************************************/
/*! exports provided: RuleGroupWrapper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RuleGroupWrapper", function() { return RuleGroupWrapper; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _rule_group_list_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./rule-group-list-component */ "./src/mappings/components/edit-mapping-component/rule-group-list-component.js");
/* harmony import */ var _blocks_wl_table__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../blocks/wl-table */ "./src/mappings/blocks/wl-table/index.js");
/**
...
const RuleGroupWrapper = () => {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_blocks_wl_table__WEBPACK_IMPORTED_MODULE_2__["WlTable"], {
    bottomAligned: true
    ...
    colSpan: 2
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b", null, "Rules")))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tbody", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
    className: "wl-bg-light wl-description wl-col-30"
  }, "Here we show the help text"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
    className: "wl-col-70"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b", null, "Use the mapping if"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_rule_group_list_component__WEBPACK_IMPORTED_MODULE_1__["default"], null))))));
};

/***/ }),

/***/ "./src/mappings/components/edit-mapping-component/title-area.js":
/*!**********************************************************************!*\
  !*** ./src/mappings/components/edit-mapping-component/title-area.js ***!
  \**********************************************************************/
/*! exports provided: TitleArea */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/mappings/components/select-component.js":
/*!*****************************************************!*\
  !*** ./src/mappings/components/select-component.js ***!
  \*****************************************************/
/*! exports provided: default */
...
class SelectComponent extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps)(SelectComponent));

/***/ }),

/***/ "./src/mappings/edit-mappings.css":
/*!****************************************!*\
  !*** ./src/mappings/edit-mappings.css ***!
  \****************************************/
/*! no static exports found */
...
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _components_edit_mapping_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/edit-mapping-component */ "./src/mappings/components/edit-mapping-component/index.js");
/* harmony import */ var _mappings_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./mappings.css */ "./src/mappings/mappings.css");
/* harmony import */ var _mappings_css__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_mappings_css__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _edit_mappings_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./edit-mappings.css */ "./src/mappings/edit-mappings.css");
/* harmony import */ var _edit_mappings_css__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_edit_mappings_css__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _store_edit_mapping_store__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./store/edit-mapping-store */ "./src/mappings/store/edit-mapping-store.js");
/**
...
window.addEventListener("load", () => {
  react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_redux__WEBPACK_IMPORTED_MODULE_2__["Provider"], {
    store: _store_edit_mapping_store__WEBPACK_IMPORTED_MODULE_6__["default"]
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_edit_mapping_component__WEBPACK_IMPORTED_MODULE_3__["default"], null)), document.getElementById("wl-edit-mappings-container"));
});

/***/ }),

/***/ "./src/mappings/filters/edit-component-filters.js":
/*!********************************************************!*\
  !*** ./src/mappings/filters/edit-component-filters.js ***!
  \********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _store_edit_mapping_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../store/edit-mapping-store */ "./src/mappings/store/edit-mapping-store.js");
/* harmony import */ var _actions_action_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../actions/action-types */ "./src/mappings/actions/action-types.js");
...
class EditComponentFilters {
  ...
  static getUniqueTaxonomiesSelected(ruleGroupList) {
    ...
    for (let rule of rules) {
      const taxonomy = rule.ruleFieldOneValue; // Dont include post type.
...
/* harmony default export */ __webpack_exports__["default"] = (EditComponentFilters);

/***/ }),

/***/ "./src/mappings/mappings.css":
/*!***********************************!*\
  !*** ./src/mappings/mappings.css ***!
  \***********************************/
/*! no static exports found */
...
/***/ "./src/mappings/reducers/edit-mapping-reducers.js":
/*!********************************************************!*\
  !*** ./src/mappings/reducers/edit-mapping-reducers.js ***!
  \********************************************************/
/*! exports provided: RuleGroupReducer, PropertyReducer, TitleReducer, NotificationReducer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RuleGroupReducer", function() { return RuleGroupReducer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PropertyReducer", function() { return PropertyReducer; });
...
/* harmony import */ var _actions_action_types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../actions/action-types */ "./src/mappings/actions/action-types.js");
/* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @reduxjs/toolkit */ "./node_modules/@reduxjs/toolkit/dist/redux-toolkit.esm.js");
/* harmony import */ var _components_edit_mapping_component_property_component_property_list_item_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/edit-mapping-component/property-component/property-list-item-component */ "./src/mappings/components/edit-mapping-component/property-component/property-list-item-component.js");
/* harmony import */ var _components_bulk_action_sub_components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/bulk-action-sub-components */ "./src/mappings/components/bulk-action-sub-components.js");
/* harmony import */ var _components_category_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/category-component */ "./src/mappings/components/category-component.js");
/**
...
const RuleGroupReducer = Object(_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(null, {
  /**
   * When add rule group is clicked then this action is fired from ui
   */
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["ADD_NEW_RULE_GROUP"]]: (state, action) => {
   ...
   */
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["ADD_NEW_RULE"]]: (state, action) => {
   ...
   */
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["DELETE_RULE"]]: (state, action) => {
    const {
      ruleGroupIndex,
      ruleIndex
   ...
   */
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["CHANGE_RULE_FIELD_VALUE"]]: (state, action) => {
    const {
      ruleGroupIndex,
      ruleIndex,
      fieldKey,
   ...
   */
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["RULE_GROUP_LIST_CHANGED"]]: (state, action) => {
   ...
   */
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["MAPPING_TERMS_CHANGED"]]: (state, action) => {
  ...
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["EDIT_MAPPING_TERMS_FETCHED_FOR_TAXONOMY"]]: (state, action) => {
...
const doPropertyBulkAction = (state, propertyIndex, selectedBulkAction) => {
  switch (selectedBulkAction) {
    case _components_bulk_action_sub_components__WEBPACK_IMPORTED_MODULE_3__["BULK_OPTIONS"].TRASH:
      changePropertyItemCategory(state, propertyIndex, _components_category_component__WEBPACK_IMPORTED_MODULE_4__["TRASH_CATEGORY"]);
      break;

    case _components_bulk_action_sub_components__WEBPACK_IMPORTED_MODULE_3__["BULK_OPTIONS"].DUPLICATE:
      addDuplicatePropertyItem(state, propertyIndex);
      break;

    case _components_bulk_action_sub_components__WEBPACK_IMPORTED_MODULE_3__["BULK_OPTIONS"].RESTORE:
      changePropertyItemCategory(state, propertyIndex, _components_category_component__WEBPACK_IMPORTED_MODULE_4__["ACTIVE_CATEGORY"]);
      break;

    case _components_bulk_action_sub_components__WEBPACK_IMPORTED_MODULE_3__["BULK_OPTIONS"].DELETE_PERMANENTLY:
...
const PropertyReducer = Object(_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(null, {
  /**
   ...
   */
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["OPEN_OR_CLOSE_PROPERTY"]]: (state, action) => {
    const {
      propertyId
    } = action.payload;
   ...
   */
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["PROPERTY_DATA_CHANGED"]]: (state, action) => {
    const {
      fieldKey,
      value,
      propertyId
   ...
   */
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["ADD_MAPPING"]]: (state, action) => {
   ...
   * network request.
   */
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["PROPERTY_LIST_CHANGED"]]: (state, action) => {
   ...
   * here
   */
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["PROPERTY_ITEM_CATEGORY_CHANGED"]]: (state, action) => {
    const {
      propertyId,
      propertyCategory
    } = action.payload;
   ...
   */
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["PROPERTY_LIST_SELECTED_CATEGORY_CHANGED"]]: (state, action) => {
    const {
      chosenCategory
    } = action.payload;
   ...
   */
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["PROPERTY_ITEM_CRUD_OPERATION"]]: (state, action) => {
    const {
      propertyId,
      operationName
    } = action.payload;
    ...
    switch (operationName) {
      ...
      case _components_edit_mapping_component_property_component_property_list_item_component__WEBPACK_IMPORTED_MODULE_2__["DELETE_PROPERTY_PERMANENT"]:
        state.propertyList.splice(propertyIndex, 1);
        break;

      case _components_edit_mapping_component_property_component_property_list_item_component__WEBPACK_IMPORTED_MODULE_2__["DUPLICATE_PROPERTY"]:
        addDuplicatePropertyItem(state, propertyIndex);
        break;
  ...
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["PROPERTY_ITEM_SELECTED"]]: (state, action) => {
    const {
      propertyId
    } = action.payload;
    const propertyIndex = state.propertyList.map(el => el.property_id).indexOf(propertyId);
  ...
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["PROPERTY_ITEM_SELECT_ALL"]]: (state, action) => {
  ...
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["PROPERTY_ITEMS_BULK_SELECT"]]: (state, action) => {
  ...
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["BULK_ACTION_SELECTION_CHANGED"]]: (state, action) => {
    const {
      selectedBulkAction
    } = action.payload;
...
const TitleReducer = Object(_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(null, {
  /**
   * When the mapping title is changed in add/edit mode then this event is fired.
   */
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["TITLE_CHANGED"]]: (state, action) => {
   ...
   */
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["MAPPING_HEADER_CHANGED"]]: (state, action) => {
   ...
   */
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["MAPPING_ID_CHANGED_FROM_API"]]: (state, action) => {
...
const NotificationReducer = Object(_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(null, {
  /**
   * When the notification is changed, then we trigger the action
   */
  [_actions_action_types__WEBPACK_IMPORTED_MODULE_0__["NOTIFICATION_CHANGED"]]: (state, action) => {
...
/***/ "./src/mappings/store/edit-mapping-sagas.js":
/*!**************************************************!*\
  !*** ./src/mappings/store/edit-mapping-sagas.js ***!
  \**************************************************/
/*! exports provided: default */
...
/* harmony import */ var _api_edit_mapping_api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../api/edit-mapping-api */ "./src/mappings/api/edit-mapping-api.js");
/* harmony import */ var _actions_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../actions/actions */ "./src/mappings/actions/actions.js");
/* harmony import */ var _actions_action_types__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../actions/action-types */ "./src/mappings/actions/action-types.js");
/* harmony import */ var _filters_edit_component_filters__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../filters/edit-component-filters */ "./src/mappings/filters/edit-component-filters.js");
/* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./selectors */ "./src/mappings/store/selectors.js");
/* harmony import */ var _edit_mapping_store__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./edit-mapping-store */ "./src/mappings/store/edit-mapping-store.js");
/**
...
function* getTermsForSelectedTaxonomy(action) {
  ...
  const parentOptions = Object(_selectors__WEBPACK_IMPORTED_MODULE_5__["getRuleFieldOneOptionByValue"])(_edit_mapping_store__WEBPACK_IMPORTED_MODULE_6__["default"].getState(), ruleFieldOneSelectedValue); // If there is no rule field one option or more than one option, then return
  ...
  const parentOption = parentOptions[0]; // If there is no api source, then dont send the request.

  if (parentOption.apiSource === undefined || parentOption.apiSource === "") {
    return;
  }

  const existingOptions = Object(_selectors__WEBPACK_IMPORTED_MODULE_5__["getOptionsFromApi"])(_edit_mapping_store__WEBPACK_IMPORTED_MODULE_6__["default"].getState(), ruleFieldOneSelectedValue);
  ...
  const callAPILink = ruleFieldOneSelectedValue === 'post_taxonomy' ? _api_edit_mapping_api__WEBPACK_IMPORTED_MODULE_1__["default"].getTaxonomyTermsFromAPI : _api_edit_mapping_api__WEBPACK_IMPORTED_MODULE_1__["default"].getTermsFromAPI;
  const response = yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["call"])(callAPILink, ruleFieldOneSelectedValue);
  ...
  _actions_actions__WEBPACK_IMPORTED_MODULE_2__["MAPPING_TERMS_CHANGED_ACTION"].payload = {
    taxonomy: ruleFieldOneSelectedValue,
    terms: terms
  };
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])(_actions_actions__WEBPACK_IMPORTED_MODULE_2__["MAPPING_TERMS_CHANGED_ACTION"]);
}
...
function* saveMappingItem(action) {
  ...
  const {
    ...
    message,
    status
  } = yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["call"])(_api_edit_mapping_api__WEBPACK_IMPORTED_MODULE_1__["default"].saveMappingItem, mappingData);
  _actions_actions__WEBPACK_IMPORTED_MODULE_2__["MAPPING_ID_CHANGED_FROM_API_ACTION"].payload = {
    mappingId: parseInt(mapping_id)
  };
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])(_actions_actions__WEBPACK_IMPORTED_MODULE_2__["MAPPING_ID_CHANGED_FROM_API_ACTION"]); // Send notification after saving.

  window !== undefined ? window.scrollTo(0, 0) : undefined;
  _actions_actions__WEBPACK_IMPORTED_MODULE_2__["NOTIFICATION_CHANGED_ACTION"].payload = {
    message: message,
    type: status
  };
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])(_actions_actions__WEBPACK_IMPORTED_MODULE_2__["NOTIFICATION_CHANGED_ACTION"]);
}

function* loadTermOptions(ruleGroupList) {
  const taxonomies = _filters_edit_component_filters__WEBPACK_IMPORTED_MODULE_4__["default"].getUniqueTaxonomiesSelected(ruleGroupList);

  for (let taxonomy of taxonomies) {
    yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])({
      type: _actions_action_types__WEBPACK_IMPORTED_MODULE_3__["EDIT_MAPPING_REQUEST_TERMS"],
      payload: {
        value: taxonomy
      }
    });
...
function* getMappingItem(action) {
  ...
  const data = yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["call"])(_api_edit_mapping_api__WEBPACK_IMPORTED_MODULE_1__["default"].getMappingItemByMappingId, mappingId);
  _actions_actions__WEBPACK_IMPORTED_MODULE_2__["MAPPING_HEADER_CHANGED_ACTION"].payload = {
    title: data.mapping_title,
    mapping_id: data.mapping_id
  };
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])(_actions_actions__WEBPACK_IMPORTED_MODULE_2__["MAPPING_HEADER_CHANGED_ACTION"]);
  _actions_actions__WEBPACK_IMPORTED_MODULE_2__["PROPERTY_LIST_CHANGED_ACTION"].payload = {
    value: _filters_edit_component_filters__WEBPACK_IMPORTED_MODULE_4__["default"].mapPropertyAPIKeysToUi(data.property_list)
  };
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])(_actions_actions__WEBPACK_IMPORTED_MODULE_2__["PROPERTY_LIST_CHANGED_ACTION"]);
  const ruleGroupList = _filters_edit_component_filters__WEBPACK_IMPORTED_MODULE_4__["default"].mapRuleGroupListAPIKeysToUi(data.rule_group_list);
  _actions_actions__WEBPACK_IMPORTED_MODULE_2__["RULE_GROUP_LIST_CHANGED_ACTION"].payload = {
    value: ruleGroupList
  };
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["call"])(loadTermOptions, ruleGroupList);
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])(_actions_actions__WEBPACK_IMPORTED_MODULE_2__["RULE_GROUP_LIST_CHANGED_ACTION"]);
}

function* editMappingSaga() {
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["takeEvery"])(_actions_action_types__WEBPACK_IMPORTED_MODULE_3__["EDIT_MAPPING_REQUEST_TERMS"], getTermsForSelectedTaxonomy);
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["takeLatest"])(_actions_action_types__WEBPACK_IMPORTED_MODULE_3__["EDIT_MAPPING_SAVE_MAPPING_ITEM"], saveMappingItem);
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["takeLatest"])(_actions_action_types__WEBPACK_IMPORTED_MODULE_3__["EDIT_MAPPING_REQUEST_MAPPING_ITEM"], getMappingItem);
}

/* harmony default export */ __webpack_exports__["default"] = (editMappingSaga);

/***/ }),

/***/ "./src/mappings/store/edit-mapping-store-filters.js":
/*!**********************************************************!*\
  !*** ./src/mappings/store/edit-mapping-store-filters.js ***!
  \**********************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (EditMappingStoreFilters);

/***/ }),

/***/ "./src/mappings/store/edit-mapping-store.js":
/*!**************************************************!*\
  !*** ./src/mappings/store/edit-mapping-store.js ***!
  \**************************************************/
/*! exports provided: default */
...
/* harmony import */ var _components_category_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/category-component */ "./src/mappings/components/category-component.js");
/* harmony import */ var _reducers_edit_mapping_reducers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../reducers/edit-mapping-reducers */ "./src/mappings/reducers/edit-mapping-reducers.js");
/* harmony import */ var _edit_mapping_sagas__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./edit-mapping-sagas */ "./src/mappings/store/edit-mapping-sagas.js");
/* harmony import */ var _actions_action_types__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../actions/action-types */ "./src/mappings/actions/action-types.js");
/* harmony import */ var _edit_mapping_store_filters__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./edit-mapping-store-filters */ "./src/mappings/store/edit-mapping-store-filters.js");
/**
...
const INITIAL_STATE = {
  ...
  RuleGroupData: {
    ...
    ruleFieldOneOptions: _edit_mapping_store_filters__WEBPACK_IMPORTED_MODULE_7__["default"].filterRuleFieldOneData(editMappingSettings.wl_rule_field_one_options),
    ruleFieldTwoOptions: _edit_mapping_store_filters__WEBPACK_IMPORTED_MODULE_7__["default"].filterRuleFieldTwoData(editMappingSettings.wl_rule_field_two_options),
    ruleLogicFieldOptions: editMappingSettings.wl_logic_field_options,
    ruleGroupList: []
  },
  PropertyListData: {
    propertyHeaderCheckboxClicked: false,
    chosenPropertyCategory: _components_category_component__WEBPACK_IMPORTED_MODULE_3__["ACTIVE_CATEGORY"],
...
const reducers = Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])({
  RuleGroupData: _reducers_edit_mapping_reducers__WEBPACK_IMPORTED_MODULE_4__["RuleGroupReducer"],
  PropertyListData: _reducers_edit_mapping_reducers__WEBPACK_IMPORTED_MODULE_4__["PropertyReducer"],
  TitleSectionData: _reducers_edit_mapping_reducers__WEBPACK_IMPORTED_MODULE_4__["TitleReducer"],
  NotificationData: _reducers_edit_mapping_reducers__WEBPACK_IMPORTED_MODULE_4__["NotificationReducer"]
});
const sagaMiddleware = Object(redux_saga__WEBPACK_IMPORTED_MODULE_1__["default"])();
const editMappingStore = Object(redux__WEBPACK_IMPORTED_MODULE_0__["createStore"])(reducers, INITIAL_STATE, Object(redux__WEBPACK_IMPORTED_MODULE_0__["applyMiddleware"])(sagaMiddleware, redux_logger__WEBPACK_IMPORTED_MODULE_2___default.a));
sagaMiddleware.run(_edit_mapping_sagas__WEBPACK_IMPORTED_MODULE_5__["default"]);
/* harmony default export */ __webpack_exports__["default"] = (editMappingStore);

/***/ }),

/***/ "./src/mappings/store/selectors.js":
/*!*****************************************!*\
  !*** ./src/mappings/store/selectors.js ***!
  \*****************************************/
/*! exports provided: getRuleFieldOneOptionByValue, getSelectedBulkOption, getSelectedMappingItems, getOptionsFromApi */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRuleFieldOneOptionByValue", function() { return getRuleFieldOneOptionByValue; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSelectedBulkOption", function() { return getSelectedBulkOption; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSelectedMappingItems", function() { return getSelectedMappingItems; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getOptionsFromApi", function() { return getOptionsFromApi; });
function getRuleFieldOneOptionByValue(state, value) {
...
const getSelectedBulkOption = state => state.selectedBulkOption;
/**
...
const getSelectedMappingItems = state => state.mappingItems.filter(item => true === item.isSelected);
/**
...
function getOptionsFromApi(state, parentValue) {
...
/******/ });
//# sourceMappingURL=mappings-edit.js.map