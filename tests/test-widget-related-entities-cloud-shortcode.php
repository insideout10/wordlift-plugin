...
class Wordlift_Related_Entities_Cloud_Shortcode_Test extends Wordlift_Unit_Test_Case {
	...
	function test_get_related_entities_tags() {
		...
		$shortcode = new Wordlift_Related_Entities_Cloud_Shortcode( Wordlift_Relation_Service::get_instance(), Wordlift_Entity_Service::get_instance() );
		...
		$widget = new Wordlift_Related_Entities_Cloud_Shortcode( Wordlift_Relation_Service::get_instance(), Wordlift_Entity_Service::get_instance()  );
		$tags   = $shortcode->get_related_entities_tags();
