    ...
    function(configuration, $window, $log) {
      return {
        ...
        templateUrl: function() {
          return (
            configuration.defaultWordLiftPath +
            "templates/wordlift-widget-be/wordlift-directive-entity-form.html?ver=3.22.0-dev"
          );
        },
        link: function($scope, $element, $attrs, $ctrl) {
          $scope.configuration = configuration;
    ...
    function(configuration, $log) {
      return {
        ...
        templateUrl: function() {
          return (
            configuration.defaultWordLiftPath +
            "templates/wordlift-widget-be/wordlift-directive-entity-input-box.html?ver=3.22.0-dev"
          );
        }
      };
    }
...
(function(_this) {
  return function($, angular) {
    ...
    container = $(
      '<div\n  id="wordlift-edit-post-wrapper"\n  ng-controller="EditPostWidgetController"\n  ng-include="configuration.defaultWordLiftPath + \'templates/wordlift-widget-be/wordlift-editpost-widget.html?ver=3.22.0-dev\'">\n</div>'
