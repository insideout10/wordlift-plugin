<?php
/*
 * Plugin Name: WordLift How To (Advanced Custom Fields Group)
 * Plugin URI: https://wordlift.io
 * Author: Naveen <naveen@wordlift.io>
 * Version: 1.0.0
 */

function install_acf_fields_custom() {
...
* Tip: An explanation in the instructions for how to achieve a result. It provides supplementary information about a technique, supply, author\'s preference, etc. It can explain what could be done, or what should not be done, but doesn\'t specify what should be done (see HowToDirection).',
		...
		acf_add_local_field_group( array(
			...
			'fields'                => array(
				...
				array(
					'key'               => 'field_5e16df2e60989',
					'label'             => 'Estimated Cost',
					'name'              => 'estimatedAmount',
					'type'              => 'text',
					'instructions'      => 'The estimated cost of the supplies consumed when performing instructions.e.g 100 USD',
					'required'          => 0,
					'conditional_logic' => 0,
					'wrapper'           => array(
						'width' => '',
...
add_action( 'init', 'install_acf_fields_custom' );
