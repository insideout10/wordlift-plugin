...
wp --allow-root core install --url=https://qa-dev.wordlift.io/5.8/ --title="5.8" --admin_name=wordlift --admin_password=8xSnT65T4KM2jWgX --admin_email=you@example.com
...
wp --allow-root config set WP_DEBUG true --path=/var/www/html/5.8/ --anchor='?php' --placement=after
wp --allow-root config set WP_DEBUG_LOG false --path=/var/www/html/5.8/ --anchor='?php' --placement=after
wp --allow-root config set WP_DEBUG_DISPLAY true --path=/var/www/html/5.8/ --anchor='?php' --placement=after
