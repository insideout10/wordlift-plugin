 ...
 * @group woocommerce
 */
class Woocommerce_Shipping_Data_Test_7 extends WP_UnitTestCase {
	...
	private function add_business_days() {

		$wpsso_options = get_option( 'wpsso_options' );

		$wpsso_options['wcsdt_shipdept_day_sunday_open']     = '00:30';
		$wpsso_options['wcsdt_shipdept_day_sunday_close']    = 'none';
		$wpsso_options['wcsdt_shipdept_day_monday_open']     = '09:30';
		$wpsso_options['wcsdt_shipdept_day_monday_close']    = '18:30';
		$wpsso_options['wcsdt_shipdept_day_tuesday_open']    = 'none';
		$wpsso_options['wcsdt_shipdept_day_tuesday_close']   = 'none';
		$wpsso_options['wcsdt_shipdept_day_wednesday_open']  = 'none';
		$wpsso_options['wcsdt_shipdept_day_wednesday_close'] = 'none';
		$wpsso_options['wcsdt_shipdept_day_thursday_open']   = 'none';
		$wpsso_options['wcsdt_shipdept_day_thursday_close']  = 'none';
		$wpsso_options['wcsdt_shipdept_day_friday_open']     = 'none';
		$wpsso_options['wcsdt_shipdept_day_friday_close']    = 'none';
		$wpsso_options['wcsdt_shipdept_day_saturday_open']   = 'none';
		$wpsso_options['wcsdt_shipdept_day_saturday_close']  = 'none';
