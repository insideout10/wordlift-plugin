...
use Wordlift\Modules\Plugin_Installer_Dependencies\Symfony\Component\Config\FileLocatorInterface;
use Wordlift\Modules\Plugin_Installer_Dependencies\Symfony\Component\Config\Loader\FileLoader as BaseFileLoader;
...
abstract class FileLoader extends BaseFileLoader
{
    ...
    private function findClasses($namespace, $pattern, $excludePattern)
    {
        ...
        $classes = [];
        $extRegexp = \defined('Wordlift\\Modules\\Plugin_Installer_Dependencies\\HHVM_VERSION') ? '/\\.(?:php|hh)$/' : '/\\.php$/';
        $prefixLen = null;
