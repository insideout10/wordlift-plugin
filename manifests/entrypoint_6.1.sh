...
wp --allow-root core install --url=https://qa-dev.wordlift.it/6.1/ --title="6.1" --admin_name=wordlift --admin_password=8xSnT65T4KM2jWgX --admin_email=you@example.com
#wp --allow-root config set WORDLIFT_API_URL https://api-dev.wordlift.io --path=/var/www/html/6.1/ --anchor='?php' --placement=after
wp --allow-root config set WP_AUTO_UPDATE_CORE false --path=/var/www/html/6.1/ --anchor='?php' --raw --placement=after
