    ...
    function(configuration, $window, $log) {
      return {
        ...
        templateUrl: function() {
          return (
            configuration.defaultWordLiftPath +
            "templates/wordlift-widget-be/wordlift-directive-entity-form.html?ver=3.24.1"
          );
        },
        link: function($scope, $element, $attrs, $ctrl) {
          $scope.configuration = configuration;
    ...
    function(configuration, $log) {
      return {
        ...
        templateUrl: function() {
          return (
            configuration.defaultWordLiftPath +
            "templates/wordlift-widget-be/wordlift-directive-entity-input-box.html?ver=3.24.1"
          );
        }
      };
    }
...
(function(_this) {
  return function($, angular) {
    ...
    container = $(
      '<div\n  id="wordlift-edit-post-wrapper"\n  ng-controller="EditPostWidgetController"\n  ng-include="configuration.defaultWordLiftPath + \'templates/wordlift-widget-be/wordlift-editpost-widget.html?ver=3.24.1\'">\n</div>'
