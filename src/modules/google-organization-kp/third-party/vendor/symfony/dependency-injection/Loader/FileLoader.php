...
use Wordlift\Modules\Google_Organization_Kp\Symfony\Component\Config\Loader\FileLoader as BaseFileLoader;
...
abstract class FileLoader extends BaseFileLoader
{
    ...
    private function findClasses($namespace, $pattern, $excludePattern)
    {
        ...
        $classes = [];
        $extRegexp = \defined('Wordlift\\Modules\\Google_Organization_Kp\\HHVM_VERSION') ? '/\\.(?:php|hh)$/' : '/\\.php$/';
        $prefixLen = null;
