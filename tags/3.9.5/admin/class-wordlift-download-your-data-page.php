...
class Wordlift_Admin_Download_Your_Data_Page {
	...
	public function admin_menu() {
		...
		add_submenu_page( 'wl_admin_menu', _x( 'Download Your Data', 'Page title', 'wordlift' ), _x( 'Download Your Data', 'Menu title', 'wordlift' ), 'manage_options', 'wl_download_your_data', array(
			$this,
			'page'
		) );
	...
	public function page() {
		...
		// Include the partial.
		include( 'partials/wordlift-admin-download-your-data.php' );
