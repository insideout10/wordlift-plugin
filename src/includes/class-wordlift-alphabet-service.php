	...
	public static function get( $language_code ) {
		...
		switch ( $language_code ) {
			...
			case 'tr' :
				...
				return explode( ',', 'A,B,C,Ç,D,E,F,G,H,I,İ,J,K,L,M,N,O,Ö,P,R,S,Ş,T,U,Ü,V,Y,Z,Q,W,X' );
