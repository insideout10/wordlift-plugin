...
function wl_admin_permalink_html( $html, $post_id, $new_title, $new_slug ) {
	...
	if ( 'publish' === get_post_status( $post_id )
		 ...
		 * @since 3.21.1
		 */
		$html          .= apply_filters( 'wl_feature__enable__vocabulary__view_linked_data', true ) ? "<span id='view-post-btn'><a href='$lod_view_href.html' class='button button-small wl-button' target='_blank'>" .
		                  esc_html__( 'View Linked Data', 'wordlift' ) .
		                  "</a></span>\n" : '';

	}

	$html .= apply_filters( 'wl_feature__enable__vocabulary__test_sd', true ) ? "<span id='view-post-btn'><a href='" . WL_CONFIG_TEST_GOOGLE_RICH_SNIPPETS_URL .
