...
use Wordlift\Modules\Food_Kg_Dependencies\Symfony\Component\Config\FileLocatorInterface;
use Wordlift\Modules\Food_Kg_Dependencies\Symfony\Component\Config\Loader\FileLoader as BaseFileLoader;
...
abstract class FileLoader extends BaseFileLoader
{
    ...
    private function findClasses($namespace, $pattern, $excludePattern)
    {
        ...
        $classes = [];
        $extRegexp = \defined('Wordlift\\Modules\\Food_Kg_Dependencies\\HHVM_VERSION') ? '/\\.(?:php|hh)$/' : '/\\.php$/';
        $prefixLen = null;
