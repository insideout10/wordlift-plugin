...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/faq/hooks/block-editor/block-editor-faq-plugin.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/faq/hooks/block-editor/block-editor-fab-button-register.js":
/*!************************************************************************!*\
  !*** ./src/faq/hooks/block-editor/block-editor-fab-button-register.js ***!
  \************************************************************************/
/*! exports provided: FAB_WRAPPER_ID, FAB_ID, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FAB_WRAPPER_ID", function() { return FAB_WRAPPER_ID; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FAB_ID", function() { return FAB_ID; });
...
/* harmony default export */ __webpack_exports__["default"] = (BlockEditorFabButtonRegister);

/***/ }),

/***/ "./src/faq/hooks/block-editor/block-editor-fab-handler.js":
/*!****************************************************************!*\
  !*** ./src/faq/hooks/block-editor/block-editor-fab-handler.js ***!
  \****************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _tinymce_tinymce_toolbar_handler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../tinymce/tinymce-toolbar-handler */ "./src/faq/hooks/tinymce/tinymce-toolbar-handler.js");
/* harmony import */ var _block_editor_fab_button_register__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block-editor-fab-button-register */ "./src/faq/hooks/block-editor/block-editor-fab-button-register.js");
/* harmony import */ var _validators_faq_validator__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../validators/faq-validator */ "./src/faq/hooks/validators/faq-validator.js");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./helpers */ "./src/faq/hooks/block-editor/helpers.js");
/**
...
class BlockEditorFabHandler {
  constructor() {
    this.faqItems = [];
    Object(backbone__WEBPACK_IMPORTED_MODULE_0__["on"])(_constants_faq_hook_constants__WEBPACK_IMPORTED_MODULE_1__["FAQ_ITEMS_CHANGED"], faqItems => {
  ...
  startListeningForSelectionChangesAndSetState() {
     ...
     */
    Object(backbone__WEBPACK_IMPORTED_MODULE_0__["on"])(_common_constants__WEBPACK_IMPORTED_MODULE_2__["SELECTION_CHANGED"], ({
      selection
    }) => {
      this.setStateBasedOnStore(Object(_helpers__WEBPACK_IMPORTED_MODULE_6__["getCurrentSelectionText"])());
    });
  }
  /**
  ...
  getFabWrapper() {
    return document.getElementById(_block_editor_fab_button_register__WEBPACK_IMPORTED_MODULE_4__["FAB_WRAPPER_ID"]);
  }
  /**
  ...
  dispatchTextSelectedToEventHandler() {
    const button = document.getElementById(_block_editor_fab_button_register__WEBPACK_IMPORTED_MODULE_4__["FAB_ID"]);
    button.addEventListener("click", event => {
      Object(backbone__WEBPACK_IMPORTED_MODULE_0__["trigger"])(_constants_faq_hook_constants__WEBPACK_IMPORTED_MODULE_1__["FAQ_EVENT_HANDLER_SELECTION_CHANGED"], {
        selectedText: Object(_helpers__WEBPACK_IMPORTED_MODULE_6__["getCurrentSelectionText"])(),
        selectedHTML: Object(_helpers__WEBPACK_IMPORTED_MODULE_6__["getCurrentSelectionHTML"])()
  ...
  setFabButtonTextBasedOnSelectedText() {
    ...
    if (button !== null) {
      const selection = Object(_helpers__WEBPACK_IMPORTED_MODULE_6__["getCurrentSelectionText"])();

      if (_validators_faq_validator__WEBPACK_IMPORTED_MODULE_5__["default"].isQuestion(selection)) {
  ...
  setStateBasedOnStore(selectedText) {
    ...
    const shouldDisableButton = _tinymce_tinymce_toolbar_handler__WEBPACK_IMPORTED_MODULE_3__["default"].shouldDisableButton(selectedText, this.faqItems);

    if (shouldDisableButton) {
      this.hideFabWrapper(wrapper);
    } else {
      // get the selection coordinates.
      const range = window.getSelection().getRangeAt(0); // we get the coordinates and then we place the button
...
/* harmony default export */ __webpack_exports__["default"] = (BlockEditorFabHandler);
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../../node_modules/webpack/buildin/global.js */ "./node_modules/webpack/buildin/global.js")))

/***/ }),

/***/ "./src/faq/hooks/block-editor/block-editor-faq-plugin.js":
/*!***************************************************************!*\
  !*** ./src/faq/hooks/block-editor/block-editor-faq-plugin.js ***!
  \***************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var _block_editor_format_type_handler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./block-editor-format-type-handler */ "./src/faq/hooks/block-editor/block-editor-format-type-handler.js");
/* harmony import */ var _block_editor_highlight_handler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block-editor-highlight-handler */ "./src/faq/hooks/block-editor/block-editor-highlight-handler.js");
/* harmony import */ var _block_editor_fab_handler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block-editor-fab-handler */ "./src/faq/hooks/block-editor/block-editor-fab-handler.js");
/* harmony import */ var _interface_faq_text_editor_hook__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../interface/faq-text-editor-hook */ "./src/faq/hooks/interface/faq-text-editor-hook.js");
/* harmony import */ var _block_editor_fab_button_register__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block-editor-fab-button-register */ "./src/faq/hooks/block-editor/block-editor-fab-button-register.js");
/**
 * Internal dependencies.
 */
...
class BlockEditorFaqPlugin extends _interface_faq_text_editor_hook__WEBPACK_IMPORTED_MODULE_3__["default"] {
  constructor(wp) {
    super();
    this.wp = wp;
  }
  ...
  performTextHighlighting() {
     ...
     * for the gutenberg
     */
    const formatTypeHandler = new _block_editor_format_type_handler__WEBPACK_IMPORTED_MODULE_0__["default"]();
    ...
    const highlightHandler = new _block_editor_highlight_handler__WEBPACK_IMPORTED_MODULE_1__["default"]();
    highlightHandler.listenForHighlightEvent();
    const toolbarRegister = new _block_editor_fab_button_register__WEBPACK_IMPORTED_MODULE_4__["default"]();
  ...
  showFloatingActionButton() {
     ...
     */
    new _block_editor_fab_handler__WEBPACK_IMPORTED_MODULE_2__["default"]();
  }
...
/***/ "./src/faq/hooks/block-editor/block-editor-format-type-handler.js":
/*!************************************************************************!*\
  !*** ./src/faq/hooks/block-editor/block-editor-format-type-handler.js ***!
  \************************************************************************/
/*! exports provided: FAQ_ANSWER_FORMAT_NAME, FAQ_QUESTION_FORMAT_NAME, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FAQ_ANSWER_FORMAT_NAME", function() { return FAQ_ANSWER_FORMAT_NAME; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FAQ_QUESTION_FORMAT_NAME", function() { return FAQ_QUESTION_FORMAT_NAME; });
...
/* harmony import */ var _custom_faq_elements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../custom-faq-elements */ "./src/faq/hooks/custom-faq-elements/index.js");
/**
...
class BlockEditorFormatTypeHandler {
  registerAnswerFormatType() {
    _custom_faq_elements__WEBPACK_IMPORTED_MODULE_1__["default"].registerFaqAnswerElement();
    Object(_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_0__["registerFormatType"])(FAQ_QUESTION_FORMAT_NAME, {
      title: "Question",
      tagName: _custom_faq_elements__WEBPACK_IMPORTED_MODULE_1__["FAQ_QUESTION_TAG_NAME"],
      className: null,
      attributes: {
        class: "class"
      }
  ...
  registerQuestionFormatType() {
    _custom_faq_elements__WEBPACK_IMPORTED_MODULE_1__["default"].registerFaqQuestionElement();
    Object(_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_0__["registerFormatType"])(FAQ_ANSWER_FORMAT_NAME, {
      title: "Answer",
      tagName: _custom_faq_elements__WEBPACK_IMPORTED_MODULE_1__["FAQ_ANSWER_TAG_NAME"],
      className: null,
      attributes: {
        class: "class"
      }
...
/* harmony default export */ __webpack_exports__["default"] = (BlockEditorFormatTypeHandler);

/***/ }),

/***/ "./src/faq/hooks/block-editor/block-editor-highlight-handler.js":
/*!**********************************************************************!*\
  !*** ./src/faq/hooks/block-editor/block-editor-highlight-handler.js ***!
  \**********************************************************************/
/*! exports provided: default */
...
/* harmony import */ var backbone__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(backbone__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _constants_faq_hook_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../constants/faq-hook-constants */ "./src/faq/constants/faq-hook-constants.js");
/* harmony import */ var _block_editor_format_type_handler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block-editor-format-type-handler */ "./src/faq/hooks/block-editor/block-editor-format-type-handler.js");
/* harmony import */ var _tinymce_tinymce_highlight_handler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../tinymce/tinymce-highlight-handler */ "./src/faq/hooks/tinymce/tinymce-highlight-handler.js");
...
/* harmony import */ var _helpers_highlight_helper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../helpers/highlight-helper */ "./src/faq/hooks/helpers/highlight-helper.js");
...
class BlockEditorHighlightHandler {
  ...
  removeHighlightingFromEditorOnDeleteEvent() {
    Object(backbone__WEBPACK_IMPORTED_MODULE_0__["on"])(_constants_faq_hook_constants__WEBPACK_IMPORTED_MODULE_1__["FAQ_ITEM_DELETED"], ({
      id,
      type
    }) => {
      ...
      for (let block of blocks) {
        const {
          blockValue,
          attributeKeyName
        } = BlockEditorHighlightHandler.getBlockValueAndKeyName(block);

        if (blockValue !== null && attributeKeyName !== null) {
          const attributes = {};
          attributes[attributeKeyName] = _helpers_highlight_helper__WEBPACK_IMPORTED_MODULE_5__["default"].removeHighlightingBasedOnType(id.toString(), type, blockValue); // Set the altered HTML to the block.
  ...
  getFormatFromEventData(data) {
    ...
    if (isQuestion) {
      format.type = _block_editor_format_type_handler__WEBPACK_IMPORTED_MODULE_2__["FAQ_QUESTION_FORMAT_NAME"];
    } else {
      format.type = _block_editor_format_type_handler__WEBPACK_IMPORTED_MODULE_2__["FAQ_ANSWER_FORMAT_NAME"];
    }
  ...
  applyFormattingForSingleBlock(formatToBeApplied) {
    ...
    if (selectedBlock.name !== "core/freeform") {
      const {
        onChange,
        value
      } = wp.data.select(_common_constants__WEBPACK_IMPORTED_MODULE_4__["WORDLIFT_STORE"]).getBlockEditorFormat();
      onChange(Object(_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_6__["toggleFormat"])(value, formatToBeApplied));
    }
  }
  /**
  ...
  applyFormattingForMultipleBlocks(formatToBeApplied, blocks, eventData) {
    for (let block of blocks) {
      ...
      if (blockValue !== null && attributeKeyName !== null) {
        const attributes = {};
        const tagName = _tinymce_tinymce_highlight_handler__WEBPACK_IMPORTED_MODULE_3__["default"].getTagBasedOnHighlightedText(eventData.isQuestion);
        attributes[attributeKeyName] = _helpers_highlight_helper__WEBPACK_IMPORTED_MODULE_5__["default"].highlightHTML(blockValue, tagName, eventData.id.toString()); // Set the altered HTML to the block.
  ...
  listenForHighlightEvent() {
    Object(backbone__WEBPACK_IMPORTED_MODULE_0__["on"])(_constants_faq_hook_constants__WEBPACK_IMPORTED_MODULE_1__["FAQ_HIGHLIGHT_TEXT"], data => {
...
/* harmony default export */ __webpack_exports__["default"] = (BlockEditorHighlightHandler);

/***/ }),

/***/ "./src/faq/hooks/block-editor/helpers.js":
/*!***********************************************!*\
  !*** ./src/faq/hooks/block-editor/helpers.js ***!
  \***********************************************/
/*! exports provided: getCurrentSelectionHTML, getCurrentSelectionText, renderHTMLAndApplyHighlightingCorrectly */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCurrentSelectionHTML", function() { return getCurrentSelectionHTML; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCurrentSelectionText", function() { return getCurrentSelectionText; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderHTMLAndApplyHighlightingCorrectly", function() { return renderHTMLAndApplyHighlightingCorrectly; });
/* harmony import */ var _block_editor_highlight_handler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./block-editor-highlight-handler */ "./src/faq/hooks/block-editor/block-editor-highlight-handler.js");
/**
  ...
  if (blocks.length > 1) {
    ...
    for (let block of blocks) {
      const {
        blockValue,
        attributeKeyName
      } = _block_editor_highlight_handler__WEBPACK_IMPORTED_MODULE_0__["default"].getBlockValueAndKeyName(block);
...
/***/ "./src/faq/hooks/custom-faq-elements/index.js":
/*!****************************************************!*\
  !*** ./src/faq/hooks/custom-faq-elements/index.js ***!
  \****************************************************/
/*! exports provided: FAQ_QUESTION_TAG_NAME, FAQ_ANSWER_TAG_NAME, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FAQ_QUESTION_TAG_NAME", function() { return FAQ_QUESTION_TAG_NAME; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FAQ_ANSWER_TAG_NAME", function() { return FAQ_ANSWER_TAG_NAME; });
/**
...
/* harmony default export */ __webpack_exports__["default"] = (CustomFaqElementsRegistry);

/***/ }),

/***/ "./src/faq/hooks/helpers/highlight-helper.js":
/*!***************************************************!*\
  !*** ./src/faq/hooks/helpers/highlight-helper.js ***!
  \***************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return HighlightHelper; });
/* harmony import */ var _components_faq_edit_item__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../components/faq-edit-item */ "./src/faq/components/faq-edit-item/index.js");
/* harmony import */ var _custom_faq_elements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../custom-faq-elements */ "./src/faq/hooks/custom-faq-elements/index.js");
/**
...
class HighlightHelper {
  ...
  static removeHighlightingBasedOnType(id, type, html) {
    if (type.toLowerCase() === _components_faq_edit_item__WEBPACK_IMPORTED_MODULE_0__["faqEditItemType"].QUESTION.toLowerCase()) {
      ...
      html = HighlightHelper.removeHighlightingTagsByClassName(html, _custom_faq_elements__WEBPACK_IMPORTED_MODULE_1__["FAQ_QUESTION_TAG_NAME"], id);
      html = HighlightHelper.removeHighlightingTagsByClassName(html, _custom_faq_elements__WEBPACK_IMPORTED_MODULE_1__["FAQ_ANSWER_TAG_NAME"], id);
    } else if (type.toLowerCase() === _components_faq_edit_item__WEBPACK_IMPORTED_MODULE_0__["faqEditItemType"].ANSWER.toLowerCase()) {
...
/***/ "./src/faq/hooks/helpers/range-helper.js":
/*!***********************************************!*\
  !*** ./src/faq/hooks/helpers/range-helper.js ***!
  \***********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (RangeHelper);

/***/ }),

/***/ "./src/faq/hooks/interface/faq-text-editor-hook.js":
/*!*********************************************************!*\
  !*** ./src/faq/hooks/interface/faq-text-editor-hook.js ***!
  \*********************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (FaqTextEditorHook);

/***/ }),

/***/ "./src/faq/hooks/tinymce/tinymce-highlight-handler.js":
/*!************************************************************!*\
  !*** ./src/faq/hooks/tinymce/tinymce-highlight-handler.js ***!
  \************************************************************/
/*! exports provided: default */
...
/* harmony import */ var backbone__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(backbone__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _constants_faq_hook_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../constants/faq-hook-constants */ "./src/faq/constants/faq-hook-constants.js");
/* harmony import */ var _custom_faq_elements__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../custom-faq-elements */ "./src/faq/hooks/custom-faq-elements/index.js");
/* harmony import */ var _helpers_highlight_helper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers/highlight-helper */ "./src/faq/hooks/helpers/highlight-helper.js");
/* harmony import */ var _helpers_range_helper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../helpers/range-helper */ "./src/faq/hooks/helpers/range-helper.js");
/**
...
class TinymceHighlightHandler {
  ...
  constructor(editor) {
    ...
    _custom_faq_elements__WEBPACK_IMPORTED_MODULE_2__["default"].registerAllElements();
    /**
    ...
    Object(backbone__WEBPACK_IMPORTED_MODULE_0__["on"])(_constants_faq_hook_constants__WEBPACK_IMPORTED_MODULE_1__["FAQ_HIGHLIGHT_TEXT"], result => {
    ...
    Object(backbone__WEBPACK_IMPORTED_MODULE_0__["on"])(_constants_faq_hook_constants__WEBPACK_IMPORTED_MODULE_1__["FAQ_ITEM_DELETED"], ({
      ...
      html = _helpers_highlight_helper__WEBPACK_IMPORTED_MODULE_3__["default"].removeHighlightingBasedOnType(id, type, html);
  ...
  static getTagBasedOnHighlightedText(isQuestion) {
    if (isQuestion) {
      return _custom_faq_elements__WEBPACK_IMPORTED_MODULE_2__["FAQ_QUESTION_TAG_NAME"];
    } else {
      return _custom_faq_elements__WEBPACK_IMPORTED_MODULE_2__["FAQ_ANSWER_TAG_NAME"];
    }
  }
  /**
  ...
  highlightSelectedText(selectedText, isQuestion, id) {
    ...
    const rangeHelper = new _helpers_range_helper__WEBPACK_IMPORTED_MODULE_4__["default"](range);
    const processedRange = rangeHelper.getProcessedRange();
    let nodes = Array.from(this.selection.getNode().childNodes);
    _helpers_highlight_helper__WEBPACK_IMPORTED_MODULE_3__["default"].highlightNodesByRange(nodes, tagName, id.toString(), range, processedRange);
    range.collapse();
  }

}

/* harmony default export */ __webpack_exports__["default"] = (TinymceHighlightHandler);

/***/ }),

/***/ "./src/faq/hooks/tinymce/tinymce-toolbar-handler.js":
/*!**********************************************************!*\
  !*** ./src/faq/hooks/tinymce/tinymce-toolbar-handler.js ***!
  \**********************************************************/
/*! exports provided: default */
...
/* harmony import */ var backbone__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(backbone__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _constants_faq_hook_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../constants/faq-hook-constants */ "./src/faq/constants/faq-hook-constants.js");
/* harmony import */ var _validators_faq_validator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../validators/faq-validator */ "./src/faq/hooks/validators/faq-validator.js");
/**
...
class TinymceToolbarHandler {
  ...
  setButtonTextBasedOnSelectedText(selectedText, button, container) {
    if (_validators_faq_validator__WEBPACK_IMPORTED_MODULE_2__["default"].isQuestion(selectedText)) {
      button.innerText = this.addQuestionText;
  ...
  static shouldDisableButton(selectedText, faqItems) {
    ...
    if (0 === questionsWithoutAnswer && !_validators_faq_validator__WEBPACK_IMPORTED_MODULE_2__["default"].isQuestion(selectedText)) {
...
/* harmony default export */ __webpack_exports__["default"] = (TinymceToolbarHandler);
...
/******/ });
//# sourceMappingURL=block-editor-faq-plugin.js.map