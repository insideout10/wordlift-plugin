...
final class ServiceLocatorTagPass extends AbstractRecursivePass {
	...
	public static function register( ContainerBuilder $container, array $refMap, $callerId = null ) {
		...
		if ( null !== $callerId ) {
			...
			$container->register( $id .= '.' . $callerId, ServiceLocator::class )->setPublic( \false )->setFactory( array( new Reference( $locatorId ), 'withContext' ) )->addArgument( $callerId )->addArgument( new Reference( 'service_container' ) );
		}
		return new Reference( $id );
	}
}
