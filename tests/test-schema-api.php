 ...
 * Class EntityTest
 */
class SchemaApiTest extends Wordlift_Unit_Test_Case {
	...
	function testSchemaProperty() {
		...
		$this->assertEquals( array(
			'http://rdf.freebase.com/my-place',
			'http://dbpedia.org/resource/my-place',
		), $value );
	...
	function testSchemaExpectedType() {
		...
		), wl_schema_get_property_expected_type( 'location' ) );
