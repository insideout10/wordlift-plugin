 ...
 */
namespace Wordlift\Modules\Food_Kg_Dependencies\Symfony\Component\Config\Resource;

use Wordlift\Modules\Food_Kg_Dependencies\Symfony\Component\DependencyInjection\ServiceSubscriberInterface;
use Wordlift\Modules\Food_Kg_Dependencies\Symfony\Component\EventDispatcher\EventSubscriberInterface;
/**
...
class ReflectionClassResource implements SelfCheckingResourceInterface, \Serializable
{
    ...
    private function generateSignature(\ReflectionClass $class)
    {
        ...
        if (\defined('Wordlift\\Modules\\Food_Kg_Dependencies\\HHVM_VERSION')) {
