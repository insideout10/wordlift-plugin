    ...
    function(configuration, $window, $log) {
      return {
        ...
        templateUrl: function() {
          return (
            configuration.defaultWordLiftPath +
            "templates/wordlift-widget-be/wordlift-directive-entity-form.html?ver=3.21.4-dev1"
          );
        },
        link: function($scope, $element, $attrs, $ctrl) {
          $scope.configuration = configuration;
...
angular
  .module("wordlift.editpost.widget.directives.wlEntityTile", [])
    ...
    function(configuration, $log) {
      return {
        ...
        templateUrl: function() {
          return (
            configuration.defaultWordLiftPath +
            "templates/wordlift-widget-be/wordlift-directive-entity-tile.html"
          );
        },
    ...
    function(configuration, $log) {
      return {
        ...
        templateUrl: function() {
          return (
            configuration.defaultWordLiftPath +
            "templates/wordlift-widget-be/wordlift-directive-entity-input-box.html?ver=3.21.4-dev1"
          );
        }
      };
    }
  ...
  .service("AnalysisService", [
    ...
    function(
      ...
      service.parse = function(data) {
        ...
        $log.debug(
          "Found " +
            Object.keys(configuration.entities).length +
        ...
        for (id in ref3) {
          ...
          if (
            ((ref5 = entity.mainType),
            indexOf.call(this._supportedTypes, ref5) < 0)
          ) {
            $log.warn(
              "Schema.org type " +
                entity.mainType +
                " for entity " +
                id +
                " is not supported from current classification boxes configuration"
            );
        ...
        for (id in ref7) {
          ...
          for (index = l = 0, len2 = ref8.length; l < len2; index = ++l) {
            ...
            if (!data.entities[ea.entityId].label) {
              ...
              $log.debug(
                "Missing label retrieved from related annotation for entity " +
                  ea.entityId
              );
            }
        ...
        embedAnalysis: (function(_this) {
          return function(analysis) {
            ...
            for (annotationId in ref) {
              ...
              if (
                -1 <
                ((ref2 = annotation.cssClass) != null
                  ? ref2.indexOf("wl-link")
                  : void 0)
              ) {
                element += " wl-link";
              }
...
(function(_this) {
  return function($, angular) {
    ...
    container = $(
      '<div\n  id="wordlift-edit-post-wrapper"\n  ng-controller="EditPostWidgetController"\n  ng-include="configuration.defaultWordLiftPath + \'templates/wordlift-widget-be/wordlift-editpost-widget.html?ver=3.21.4-dev1\'">\n</div>'
