 ...
 */
namespace Wordlift\Modules\Common\Symfony\Contracts\Service\Test;
...
abstract class ServiceLocatorTestCase extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\Wordlift\Modules\Common\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\Wordlift\Modules\Common\Psr\Container\ContainerExceptionInterface::class);
