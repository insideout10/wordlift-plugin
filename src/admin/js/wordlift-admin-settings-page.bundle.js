...
var _keyValidator = __webpack_require__(304);

var _keyValidator2 = _interopRequireDefault(_keyValidator);

var _mediaUploader = __webpack_require__(305);

var _mediaUploader2 = _interopRequireDefault(_mediaUploader);

var _tabs = __webpack_require__(306);
...
(function ($, settings) {
	$(function () {
		...
		(0, _keyValidator2.default)('#wl-key');

		// Attach the Media Uploader to the #wl-publisher-logo
		(0, _mediaUploader2.default)('#wl-publisher-media-uploader', {
		...
		// Create the tabs.
		(0, _tabs2.default)('.wl-tabs-element');
	});
})(jQuery, wlSettings);
...
var _delay = __webpack_require__(61);
...
var KeyValidator = function KeyValidator(selector) {
	$(selector).on('keyup', function () {
		...
		(0, _delay2.default)($this, function () {
