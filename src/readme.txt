...
= 3.54.13 (2026-06-30) =
* Fix: Prevented caching of private content in API endpoints.

= 3.54.12 (2026-06-29) =
* **Security:** Fixed a vulnerability in the JSON-LD REST API that exposed metadata from unpublished posts.
