...
use Wordlift\Modules\Common\Symfony\Component\Config\Definition\BooleanNode;
...
use Wordlift\Modules\Common\Symfony\Component\Config\Definition\Exception\InvalidConfigurationException;
use Wordlift\Modules\Common\Symfony\Component\Config\Definition\FloatNode;
use Wordlift\Modules\Common\Symfony\Component\Config\Definition\IntegerNode;
...
use Wordlift\Modules\Common\Symfony\Component\Config\Definition\ScalarNode;
use Wordlift\Modules\Common\Symfony\Component\Config\Definition\VariableNode;
...
class ConfigBuilderGenerator implements ConfigBuilderGeneratorInterface
{
    ...
    public function build(ConfigurationInterface $configuration): \Closure
    {
        ...
        $rootClass = new ClassBuilder('Wordlift\Modules\Common\Symfony\Config', $rootNode->getName());
