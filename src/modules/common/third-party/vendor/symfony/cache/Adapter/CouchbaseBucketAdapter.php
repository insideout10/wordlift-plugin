...
class CouchbaseBucketAdapter extends AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\Wordlift\Modules\Common\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, ?MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []): \Wordlift\Modules\Common\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \Wordlift\Modules\Common\CouchbaseCluster($connectionString);
