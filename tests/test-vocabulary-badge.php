...
class Vocabulary_Badge_Test extends \Wordlift_Vocabulary_Unit_Test_Case {
	...
	public function test_round_to_nearest_hundred_for_term_count() {
		...
		$result = Badge_Generator::get_ui_count( 340 );
		$this->assertEquals( 100, $result );
		$result = Badge_Generator::get_ui_count( 290 );
		$this->assertEquals( 100, $result );
		$result = Badge_Generator::get_ui_count( 200 );
		$this->assertEquals( 100, $result );
		$result = Badge_Generator::get_ui_count( 70 );
