...
use Wordlift\Modules\Plugin_Diagnostics\Symfony\Component\Config\Loader\FileLoader as BaseFileLoader;
...
abstract class FileLoader extends BaseFileLoader
{
    ...
    private function findClasses($namespace, $pattern, $excludePattern)
    {
        ...
        $classes = [];
        $extRegexp = \defined('Wordlift\\Modules\\Plugin_Diagnostics\\HHVM_VERSION') ? '/\\.(?:php|hh)$/' : '/\\.php$/';
        $prefixLen = null;
