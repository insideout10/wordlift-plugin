...
wp --allow-root core install --url=https://qa-dev.wordlift.it/5.4/ --title="5.4" --admin_name=wordlift --admin_password=8xSnT65T4KM2jWgX --admin_email=you@example.com
...
wp --allow-root plugin install woocommerce --version=5.1.0
