...
* For complicated installs 😅, now it is possible to override the production URL.
...
= 3.45.0 (2023-05-25) =
* Enhancement [#1675](https://github.com/insideout10/wordlift-plugin/issues/1675): We super power Yoast structured data markup with upscaled images.
...
= 3.44.6 (2023-05-22) =
* Fix [#1690](https://github.com/insideout10/wordlift-plugin/issues/1690): Check that we found a Content before attempting to use it.
...
* Fix [#1613](https://github.com/insideout10/wordlift-plugin/issues/1613): Fix about match in post title is bogus.
* Fix [#1618](https://github.com/insideout10/wordlift-plugin/issues/1618): Display the suggested images tab only when there are suggested images.
...
* Fix [#1559](https://github.com/insideout10/wordlift-plugin/issues/1559): Fix term edit screen styling.
...
* Fix [#1513](https://github.com/insideout10/wordlift-plugin/issues/1513): Be compatible with multisite users when pushing to KG.
...
* Enhancement [#1461](https://github.com/insideout10/wordlift-plugin/issues/1461): Add the author.url property

= 3.32.5 (2021-08-10) =

* Fix [#1459](https://github.com/insideout10/wordlift-plugin/issues/1459): Term entity fields not appearing on CPT or custom taxonomies.
...
* Fix [#1098](https://github.com/insideout10/wordlift-plugin/issues/1098): Entities saved from Block Editor have no slug.
...
* Fix [#1045](https://github.com/insideout10/wordlift-plugin/issues/1045): Fix for link switch isn't on when linking to an entity is on by default.
...
= 3.23.7.1 (2020-01-14) =
* Fix: JavaScript error on entity.images null.
