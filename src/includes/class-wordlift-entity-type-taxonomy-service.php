...
class Wordlift_Entity_Type_Taxonomy_Service {
	...
	public function init() {
		...
		$args = array(
			...
			'hierarchical'       => true,
			'show_admin_column'  => apply_filters( 'wl_feature__enable__vocabulary__entity_types_taxonomy', true ),
			'show_in_rest'       => apply_filters( 'wl_feature__enable__vocabulary__entity_types_taxonomy', true ),
		...
		if ( WL_ALL_ENTITY_TYPES ) {
			$args['meta_box_cb'] = apply_filters( 'wl_feature__enable__vocabulary__entity_types_taxonomy', true ) ? array( 'Wordlift_Admin_Schemaorg_Taxonomy_Metabox', 'render' ) : false;
		}
