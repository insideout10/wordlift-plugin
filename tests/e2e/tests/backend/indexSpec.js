...
var _LoginToWordPress = __webpack_require__(1);

var _LoginToWordPress2 = _interopRequireDefault(_LoginToWordPress);

var _SetupPage = __webpack_require__(2);
...
var _PostEditPage = __webpack_require__(4);

var _PostEditPage2 = _interopRequireDefault(_PostEditPage);
...
describe('test WordLift', function () {
	...
	it('log into WordPress backend', _LoginToWordPress2.default);
	...
	// be tested.
	describe('test the Setup Page', _SetupPage2.default);

	// Test the WordLift Settings Page.
	describe('test the Settings Page', _SettingsPage2.default);

	// Test the Post Edit Page.
	describe('test the Post Edit Page', _PostEditPage2.default);
});
...
exports.default = LoginToWordPress;
