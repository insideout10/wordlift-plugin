...
/***/ "./node_modules/@wordlift/wordlift-for-schemaorg/build/wordlift-for-schemaorg.js":
/*!***************************************************************************************!*\
  !*** ./node_modules/@wordlift/wordlift-for-schemaorg/build/wordlift-for-schemaorg.js ***!
  \***************************************************************************************/
...
/***/ "./src/Edit/SchemaClassTree/sortByNameCaseInsensitive.js":
/*!***************************************************************!*\
  !*** ./src/Edit/SchemaClassTree/sortByNameCaseInsensitive.js ***!
  \***************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (sortByNameCaseInsensitive);

/***/ }),

/***/ "./src/Edit/SchemaClassTree/withLoader.js":
/*!************************************************!*\
  !*** ./src/Edit/SchemaClassTree/withLoader.js ***!
  \************************************************/
/*! exports provided: default */
...
/* harmony import */ var _sortByNameCaseInsensitive__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sortByNameCaseInsensitive */ "./src/Edit/SchemaClassTree/sortByNameCaseInsensitive.js");
...
const withLoader = Component => class extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
  ...
  componentDidMount() {
    wp.ajax.post("wl_schemaorg_class", {}).then(json => json["schemaClasses"]).then(_sortByNameCaseInsensitive__WEBPACK_IMPORTED_MODULE_1__["default"]).then(this.onData);
  }
  /**
  ...
  render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Component, _extends({}, this.props, {
      items: items,
      roots: roots,
      open: open
    }));
...
/* harmony default export */ __webpack_exports__["default"] = (withLoader);

/***/ }),

/***/ "./src/Edit/SchemaClassTree/withProps.js":
/*!***********************************************!*\
  !*** ./src/Edit/SchemaClassTree/withProps.js ***!
  \***********************************************/
/*! exports provided: default */
...
const withProp = propName => Component => class extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Component, _extends({}, this.props, methods));
  }
...
/* harmony default export */ __webpack_exports__["default"] = (withProps);
...
function EditorSelectionChangedEvent() {
  return function (dispatch) {
    ...
    wp.wordlift.on("editorSelectionChanged", function (args) {
      ...
      // might be inside a reducer call.
      setTimeout(function () {
        dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_0__["editorSelectionChanged"])(args));
      }, 0);
    });
  };
} // Finally export the function.
...
class IngredientAutocompleteSelect extends _components_Autocomplete_AutocompleteSelect__WEBPACK_IMPORTED_MODULE_1__["default"] {
  onChange(value) {
...
window.addEventListener("load", () => {
  document.querySelectorAll(".wl-select-main-ingredient").forEach(el => {
    react_dom__WEBPACK_IMPORTED_MODULE_0___default.a.render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(IngredientAutocompleteSelect, {
      loadOptions: autocomplete,
      ...
      loadingPlaceholder: settings.l10n["Please wait while we look for entities in the linked data cloud..."],
      noResultsText: settings.l10n["No results found for your search."],
      optionRenderer: props => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, props)
    }), el);
  });
});
