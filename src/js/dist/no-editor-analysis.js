...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/no-editor-analysis/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
function* toggleEntity(payload) {
  const entity = yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["select"])(_selectors__WEBPACK_IMPORTED_MODULE_3__["getEntity"], payload.entity.id); // @@todo
  //
  // $.ajax({
...
class EditorOps {
  ...
  buildAnalysisRequest(language, exclude, canCreateEntities) {
    ...
    if ((_window$wlSettings = window['wlSettings']) !== null && _window$wlSettings !== void 0 && _window$wlSettings.post_id) {
      var _window$wlSettings2;

      request['post_id'] = (_window$wlSettings2 = window['wlSettings']) === null || _window$wlSettings2 === void 0 ? void 0 : _window$wlSettings2.post_id;
    }
  ...
  insertAnnotation(id, start, end) {
    ...
    if (false === block || false === endBlock || block !== endBlock) {
      return false;
    }
...
/***/ "./src/no-editor-analysis/actions/index.js":
/*!*************************************************!*\
  !*** ./src/no-editor-analysis/actions/index.js ***!
  \*************************************************/
/*! exports provided: syncFormData, analysisStateChanged */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "syncFormData", function() { return syncFormData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "analysisStateChanged", function() { return analysisStateChanged; });
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./types */ "./src/no-editor-analysis/actions/types.js");
/**
 * @author Naveen Muthusamy <naveen@wordlift.io>
 * @since 3.32.6
...
const syncFormData = () => ({
  type: _types__WEBPACK_IMPORTED_MODULE_0__["NO_EDITOR_SYNC_FORM_DATA"]
});
const analysisStateChanged = isRunning => {
  if (isRunning) {
    return {
      type: _types__WEBPACK_IMPORTED_MODULE_0__["ANALYSIS_RUNNING"]
    };
  }

  return {
    type: _types__WEBPACK_IMPORTED_MODULE_0__["ANALYSIS_COMPLETE"]
  };
};

/***/ }),

/***/ "./src/no-editor-analysis/actions/types.js":
/*!*************************************************!*\
  !*** ./src/no-editor-analysis/actions/types.js ***!
  \*************************************************/
/*! exports provided: NO_EDITOR_SYNC_FORM_DATA, ANALYSIS_RUNNING, ANALYSIS_COMPLETE */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NO_EDITOR_SYNC_FORM_DATA", function() { return NO_EDITOR_SYNC_FORM_DATA; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ANALYSIS_RUNNING", function() { return ANALYSIS_RUNNING; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ANALYSIS_COMPLETE", function() { return ANALYSIS_COMPLETE; });
/**
 * @author Naveen Muthusamy <naveen@wordlift.io>
 * @since 3.32.6
 * Actions types fired on the no editor analysis.
 */
const NO_EDITOR_SYNC_FORM_DATA = 'NO_EDITOR_SYNC_FORM_DATA';
const ANALYSIS_RUNNING = 'ANALYSIS_RUNNING';
const ANALYSIS_COMPLETE = 'ANALYSIS_COMPLETE';

/***/ }),

/***/ "./src/no-editor-analysis/analysis-storage/index.js":
/*!**********************************************************!*\
  !*** ./src/no-editor-analysis/analysis-storage/index.js ***!
  \**********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AnalysisStorage; });
/**
 * @since 3.32.6
 * @author Naveen Muthusamy <naveen@wordlift.io>
 */
...
class AnalysisStorage {
  ...
  generateForSingleField(entityId, fieldName, value, isArrayField = false) {
    const fieldHtmlName = isArrayField ? `wl_entities[${entityId}][${fieldName}][]` : `wl_entities[${entityId}][${fieldName}]`;
...
/***/ "./src/no-editor-analysis/components/root/index.js":
/*!*********************************************************!*\
  !*** ./src/no-editor-analysis/components/root/index.js ***!
  \*********************************************************/
/*! exports provided: default */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _vocabulary_components_wl_loading_animation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../vocabulary/components/wl-loading-animation */ "./src/vocabulary/components/wl-loading-animation/index.js");
...
class Root extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, this.props.analysisRunning && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_vocabulary_components_wl_loading_animation__WEBPACK_IMPORTED_MODULE_1__["WlLoadingAnimation"], null), !this.props.analysisRunning && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Edit_components_App__WEBPACK_IMPORTED_MODULE_2__["default"], null));
  }
...
/***/ "./src/no-editor-analysis/index.js":
/*!*****************************************!*\
  !*** ./src/no-editor-analysis/index.js ***!
  \*****************************************/
/*! no exports provided */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _stores__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./stores */ "./src/no-editor-analysis/stores/index.js");
/* harmony import */ var _block_editor_stores_actions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../block-editor/stores/actions */ "./src/block-editor/stores/actions.js");
/* harmony import */ var _block_editor_filters_add_entity_filters__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../block-editor/filters/add-entity.filters */ "./src/block-editor/filters/add-entity.filters.js");
/* harmony import */ var _components_root__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/root */ "./src/no-editor-analysis/components/root/index.js");
/**
 * External dependencies.
 */
...
Object(_block_editor_filters_add_entity_filters__WEBPACK_IMPORTED_MODULE_5__["default"])(_stores__WEBPACK_IMPORTED_MODULE_3__["default"]);
window.addEventListener("load", () => {
  const container = document.getElementById('wl-no-editor-analysis-meta-box-content'); // Render the classification sidebar.

  react_dom__WEBPACK_IMPORTED_MODULE_0___default.a.render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react_redux__WEBPACK_IMPORTED_MODULE_1__["Provider"], {
    store: _stores__WEBPACK_IMPORTED_MODULE_3__["default"]
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_root__WEBPACK_IMPORTED_MODULE_6__["default"], null)), container); // Load the analysis results.

  _stores__WEBPACK_IMPORTED_MODULE_3__["default"].dispatch(Object(_block_editor_stores_actions__WEBPACK_IMPORTED_MODULE_4__["requestAnalysis"])({
    loading: true
  }));
});
...
/***/ "./src/no-editor-analysis/stores/index.js":
/*!************************************************!*\
  !*** ./src/no-editor-analysis/stores/index.js ***!
  \************************************************/
/*! exports provided: default */
...
/* harmony import */ var _sagas__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./sagas */ "./src/no-editor-analysis/stores/sagas.js");
...
/* harmony import */ var _Edit_reducers_editor__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../Edit/reducers/editor */ "./src/Edit/reducers/editor.js");
/* harmony import */ var _actions_types__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../actions/types */ "./src/no-editor-analysis/actions/types.js");
...
const analysisRunning = function (state = false, action) {
  ...
  if (type === _actions_types__WEBPACK_IMPORTED_MODULE_9__["ANALYSIS_COMPLETE"]) {
    return false;
  }

  if (type === _actions_types__WEBPACK_IMPORTED_MODULE_9__["ANALYSIS_RUNNING"]) {
    return true;
  }
...
const reducer = Object(redux__WEBPACK_IMPORTED_MODULE_1__["combineReducers"])({
  ...
  editor: _Edit_reducers_editor__WEBPACK_IMPORTED_MODULE_8__["default"],
  analysisRunning,
...
}, Object(redux__WEBPACK_IMPORTED_MODULE_1__["applyMiddleware"])(sagaMiddleware, redux_thunk__WEBPACK_IMPORTED_MODULE_3__["default"], redux_logger__WEBPACK_IMPORTED_MODULE_0___default.a));
sagaMiddleware.run(_sagas__WEBPACK_IMPORTED_MODULE_4__["default"]); // Finally export the store.

/* harmony default export */ __webpack_exports__["default"] = (store);

/***/ }),

/***/ "./src/no-editor-analysis/stores/sagas.js":
/*!************************************************!*\
  !*** ./src/no-editor-analysis/stores/sagas.js ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! redux-saga/effects */ "./node_modules/redux-saga/dist/redux-saga-effects-npm-proxy.esm.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _wordpress_hooks__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/hooks */ "@wordpress/hooks");
/* harmony import */ var _wordpress_hooks__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _Edit_constants_ActionTypes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../Edit/constants/ActionTypes */ "./src/Edit/constants/ActionTypes.js");
/* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./selectors */ "./src/no-editor-analysis/stores/selectors.js");
/* harmony import */ var _Edit_components_AddEntity_actions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../Edit/components/AddEntity/actions */ "./src/Edit/components/AddEntity/actions.js");
/* harmony import */ var _block_editor_stores_actions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../block-editor/stores/actions */ "./src/block-editor/stores/actions.js");
/* harmony import */ var _block_editor_stores_compat__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../block-editor/stores/compat */ "./src/block-editor/stores/compat.js");
/* harmony import */ var _Edit_actions__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../Edit/actions */ "./src/Edit/actions/index.js");
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../actions */ "./src/no-editor-analysis/actions/index.js");
/* harmony import */ var _actions_types__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../actions/types */ "./src/no-editor-analysis/actions/types.js");
/* harmony import */ var _analysis_storage__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../analysis-storage */ "./src/no-editor-analysis/analysis-storage/index.js");
/* harmony import */ var _Edit_uuid__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../Edit/uuid */ "./src/Edit/uuid.js");
/* harmony import */ var _block_editor_stores_sagas__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../block-editor/stores/sagas */ "./src/block-editor/stores/sagas.js");
/**
 * This file contains the side effects managed via redux-sagas.
 *
 * @author Naveen Muthusamy <naveen@wordlift.io>
...
function* toggleEntity(payload) {
  const entity = yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["select"])(_selectors__WEBPACK_IMPORTED_MODULE_4__["getEntity"], payload.entity.id);

  if (entity.occurrences.length === 0) {
    // turn on the entity
    yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])(Object(_Edit_actions__WEBPACK_IMPORTED_MODULE_8__["updateOccurrencesForEntity"])(entity.id, ["placeholder-annotation"]));
  } else {
    yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])(Object(_Edit_actions__WEBPACK_IMPORTED_MODULE_8__["updateOccurrencesForEntity"])(entity.id, []));
  }

  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])(Object(_actions__WEBPACK_IMPORTED_MODULE_9__["syncFormData"])());
}
...
function* handleRequestAnalysis() {
  ...
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])(Object(_actions__WEBPACK_IMPORTED_MODULE_9__["analysisStateChanged"])(true));
  const response = yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["call"])(global["wp"].ajax.post, "wl_analyze", {
    _wpnonce: settings["analysis"]["_wpnonce"],
    data: JSON.stringify(request),
    postId: settings["post_id"]
  });
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])(Object(_actions__WEBPACK_IMPORTED_MODULE_9__["analysisStateChanged"])(false));
  const parsed = Object(_block_editor_stores_compat__WEBPACK_IMPORTED_MODULE_7__["default"])(response);
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])(Object(_Edit_actions__WEBPACK_IMPORTED_MODULE_8__["receiveAnalysisResults"])(parsed));
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])(Object(_actions__WEBPACK_IMPORTED_MODULE_9__["syncFormData"])());
}
...
function* addEntity({
  ...
  payload.id = payload.id ? payload.id : 'local-entity-' + Object(_Edit_uuid__WEBPACK_IMPORTED_MODULE_12__["default"])();
  payload.mainType = Object(_block_editor_stores_sagas__WEBPACK_IMPORTED_MODULE_13__["getEntityType"])(payload);
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])({
    type: _Edit_constants_ActionTypes__WEBPACK_IMPORTED_MODULE_3__["ADD_ENTITY"],
    payload: payload
  });
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])(Object(_Edit_components_AddEntity_actions__WEBPACK_IMPORTED_MODULE_5__["addEntitySuccess"])());
  Object(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_2__["doAction"])("unstable_wordlift.closeEntitySelect");
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])(Object(_actions__WEBPACK_IMPORTED_MODULE_9__["syncFormData"])());
}

function* handleSyncFormData() {
  const selectedEntities = yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["select"])(_selectors__WEBPACK_IMPORTED_MODULE_4__["getAllSelectedEntities"]);
  const storage = new _analysis_storage__WEBPACK_IMPORTED_MODULE_11__["default"]("wl-no-editor-analysis-meta-box-storage");
...
function* sagas() {
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["takeEvery"])(_Edit_constants_ActionTypes__WEBPACK_IMPORTED_MODULE_3__["TOGGLE_ENTITY"], toggleEntity);
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["takeLatest"])(_block_editor_stores_actions__WEBPACK_IMPORTED_MODULE_6__["requestAnalysis"], handleRequestAnalysis);
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["takeEvery"])(_Edit_components_AddEntity_actions__WEBPACK_IMPORTED_MODULE_5__["addEntityRequest"], addEntity);
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["takeEvery"])(_actions_types__WEBPACK_IMPORTED_MODULE_10__["NO_EDITOR_SYNC_FORM_DATA"], handleSyncFormData);
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["takeEvery"])(_Edit_components_AddEntity_actions__WEBPACK_IMPORTED_MODULE_5__["createEntityRequest"], handleCreateEntityRequest);
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["takeEvery"])(_Edit_constants_ActionTypes__WEBPACK_IMPORTED_MODULE_3__["SET_CURRENT_ENTITY"], handleSetCurrentEntity);
}
...
/***/ "./src/no-editor-analysis/stores/selectors.js":
/*!****************************************************!*\
  !*** ./src/no-editor-analysis/stores/selectors.js ***!
  \****************************************************/
/*! exports provided: getEntity, getAllSelectedEntities */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getEntity", function() { return getEntity; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAllSelectedEntities", function() { return getAllSelectedEntities; });
/**
 * @author Naveen Muthusamy <naveen@wordlift.io>
 * @since 3.32.6
 * This file defines the selectors.
...
const getAllSelectedEntities = state => state.entities.filter(e => e.occurrences && e.occurrences.length > 0);
...
/******/ });
//# sourceMappingURL=no-editor-analysis.js.map