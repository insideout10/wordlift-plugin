 ...
 */
namespace Wordlift\Modules\Google_Organization_Kp\Symfony\Component\Config\Resource;

use Wordlift\Modules\Google_Organization_Kp\Symfony\Component\DependencyInjection\ServiceSubscriberInterface;
use Wordlift\Modules\Google_Organization_Kp\Symfony\Component\EventDispatcher\EventSubscriberInterface;
/**
...
class ReflectionClassResource implements SelfCheckingResourceInterface, \Serializable
{
    ...
    private function generateSignature(\ReflectionClass $class)
    {
        ...
        if (\defined('Wordlift\\Modules\\Google_Organization_Kp\\HHVM_VERSION')) {
