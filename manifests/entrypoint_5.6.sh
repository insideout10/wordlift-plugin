...
wp --allow-root config set WORDLIFT_API_URL https://api-dev.wordlift.io --path=/var/www/html/5.6/ --anchor='/**'
wp --allow-root config set WP_AUTO_UPDATE_CORE false --path=/var/www/html/5.6/ --anchor='/**'
