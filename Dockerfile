FROM wordpress:4.4 as wlp-wp-4.4
...
FROM wordpress:4.7 as wlp-wp-4.7
...
FROM wordpress:5.0 as wlp-wp-5.0
...
FROM wordpress:5.4 as wlp-wp-5.4
...
FROM wordpress:5.5 as wlp-wp-5.5
...
FROM wordpress:5.6 as wlp-wp-5.6
...
FROM wordpress:5.7 as wlp-wp-5.7
...
FROM wordpress:5.8 as wlp-wp-5.8
