...
/**
 * Process references to addresses either returning a {@link Wordlift_Property_Entity_Reference}
 * instance or a place name.
 *
 * @since 3.27.3
 */
class Wordlift_Address_Property_Service extends Wordlift_Entity_Property_Service {
