...
var _wordlift = __webpack_require__(110);

var _wordlift2 = _interopRequireDefault(_wordlift);

var _delay = __webpack_require__(111);
  ...
  */
   ...
   */
		var callback = function callback() {
			...
			(0, _delay2.default)($this, _check2.default, $, wp.ajax, $this.val(), wlSettings.post_id, wlSettings.l10n['You already published an entity with the same name'], function (html) {
...
exports.default = window.wp.wordlift;
