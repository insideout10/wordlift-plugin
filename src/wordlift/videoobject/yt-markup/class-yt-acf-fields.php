			...
			acf_add_local_field_group( array(
				...
				'fields'                => array(
					array(
						...
						'label'             => 'video',
						'name'              => 'wordlift_videoobject_video',
						'type'              => 'repeater',
						'instructions'      => 'This data in these fields are added automatically when you embed a video from youtube, dont add the data manually in these fields.',
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => array(
							'width' => '',
				...
				'location'              => Yt_Config::get_locations_for_acf(),
				'menu_order'            => 0,
				'position'              => 'normal',
				'style'                 => 'default',
				'label_placement'       => 'top',
