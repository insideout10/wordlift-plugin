 ...
 * @group woocommerce
 */
class Woocommerce_Shipping_Data_Test_6_1 extends WP_UnitTestCase {
	...
	private function add_cutoff_time() {

		$wpsso_options = get_option( 'wpsso_options' );

		$wpsso_options['wcsdt_shipdept_cutoff']   = '01:00';
		$wpsso_options['wcsdt_shipdept_timezone'] = 'Europe/Rome';
