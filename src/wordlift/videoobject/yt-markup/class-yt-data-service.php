...
class Yt_Data_Service extends Singleton {

	const API_URL = 'https://www.googleapis.com/youtube/v3/videos';

	/**
	 * @return Yt_Data_Service
	 */
	 ...
	 * @param $video_urls
	 *
	 * @return bool | array<Yt_Video_Data>
	 */
	...
	private function get_api_key() {
		return get_option( Yt_Settings_Page::API_FIELD_NAME, false );
	}
	...
	private function parse_youtube_video_data_from_response( $response_body ) {
		...
		foreach ( $videos_json_data as $single_video_json_data ) {
			$videos[] = new Yt_Video_Data( $single_video_json_data );
		}
