...
class Edit_Mapping_Page_Test extends Wordlift_Unit_Test_Case {
	...
	public function setUp() {
		...
		$this->markTestSkipped( 'Revise this as a unit test.' );

		add_filter( 'wl_feature__enable__mappings', '__return_true', PHP_INT_MAX );
	...
	function tearDown() {
		remove_filter( 'wl_feature__enable__mappings', '__return_true', PHP_INT_MAX );
