 ...
 */
namespace Wordlift\Modules\Common\Symfony\Component\Config\Definition\Builder;

use Wordlift\Modules\Common\Symfony\Component\Config\Definition\ArrayNode;
use Wordlift\Modules\Common\Symfony\Component\Config\Definition\Exception\InvalidDefinitionException;
...
class ArrayNodeDefinition extends NodeDefinition implements ParentNodeDefinitionInterface {
	...
	public function canBeEnabled() {
		$this->addDefaultsIfNotSet()->treatFalseLike( array( 'enabled' => \false ) )->treatTrueLike( array( 'enabled' => \true ) )->treatNullLike( array( 'enabled' => \true ) )->beforeNormalization()->ifArray()->then(
			function ( $v ) {
	...
	public function canBeDisabled() {
		$this->addDefaultsIfNotSet()->treatFalseLike( array( 'enabled' => \false ) )->treatTrueLike( array( 'enabled' => \true ) )->treatNullLike( array( 'enabled' => \true ) )->children()->booleanNode( 'enabled' )->defaultTrue();
		return $this;
	}
	/**
